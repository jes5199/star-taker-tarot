...
\minorcard[{\playingcardmarks{black}{2}{♣}{1.0}{1.0}
  ...
  \foreach \d in {0,1,...,10} {
    ...
    \draw[black, thin] (0, \ypos pt) -- (0.5mm, \ypos pt);
  }
  % Solar terms and pentads
  \pgfmathsetmacro{\fivedegs}{5 * (\cardheight-20mm)/10}%
  \pgfmathsetmacro{\decanheight}{\cardheight-20mm}%
  % Solar term column box
  \draw[black, thin] (1mm, 0) rectangle (2.5mm, \decanheight pt);
  % 春分 Spring Equinox at 0°
  \node[anchor=west, rotate=90, text=black]
    at (1.5mm, 0.5mm) {{\cjkfont\fontsize{6}{7}\selectfont 春分} {\cardfont\fontsize{6}{7}\selectfont Spring Equinox}};
  % Pentad column box
  \draw[black, thin] (5mm, 0) rectangle (6.5mm, \decanheight pt);
  % 玄鳥至 Swallows arrive at 0°
  \node[anchor=west, rotate=90, text=black]
    at (5.5mm, 0.5mm) {{\cjkfont\fontsize{6}{7}\selectfont 玄鳥至} {\cardfont\fontsize{6}{7}\selectfont Swallows arrive}};
  % 雷乃發聲 Thunder sounds at 5°
  \node[anchor=west, rotate=90, text=black]
    at (5.5mm, \fivedegs pt + 0.5mm) {{\cjkfont\fontsize{6}{7}\selectfont 雷乃發聲} {\cardfont\fontsize{6}{7}\selectfont Thunder sounds}};
  % Xiù column box
  \draw[black, thin] (9mm, 0) rectangle (10.5mm, \decanheight pt);
  % Xiù boundary at 03°24' Aries: 室 Shì (Encampment) ends, 壁 Bì (Wall) starts
  \pgfmathsetmacro{\xiuboundary}{(3 + 24/60) * (\cardheight-20mm)/10}%
  \draw[black, thick] (9mm, \xiuboundary pt) -- (10.5mm, \xiuboundary pt);
  \node[anchor=west, rotate=90, text=black]
    at (9.5mm, \xiuboundary pt + 0.5mm) {{\cjkfont\fontsize{6}{7}\selectfont 壁} {\cardfont\fontsize{6}{7}\selectfont 14 Wall}};
  \node[anchor=east, rotate=90, text=black]
    at (9.5mm, \xiuboundary pt - 0.5mm) {{\cardfont\fontsize{6}{7}\selectfont 13 Encampment} {\cjkfont\fontsize{6}{7}\selectfont 室}};
  % Algenib (γ Pegasi) at 09°35' Aries
  \pgfmathsetmacro{\algenibpos}{(9 + 35/60) * (\cardheight-20mm)/10}%
  \node[anchor=center, text=black, font=\symbfont\fontsize{6}{7}\selectfont]
    at (1.5mm, \algenibpos pt) {★};
  \node[anchor=south west, rotate=45, text=black, font=\cardfont\fontsize{6}{7}\selectfont, inner sep=0.5pt]
    at (2mm, \algenibpos pt) {Algenib};
