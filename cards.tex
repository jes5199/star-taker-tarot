...
\newcommand{\fixedstar}[2]{%
  \pgfmathsetmacro{\starpos}{#1 * (\cardheight-20mm)/10}%
  \node[anchor=west, text=black, inner sep=0pt]
    at (2.5mm, \starpos pt) {{\symbfont\fontsize{5}{6}\selectfont ★}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont #2}};
}
...
\newcommand{\padasyllable}[3]{%
  \pgfmathsetmacro{\padabot}{#1 * (\cardheight-20mm)/10}%
  \node[anchor=south west, draw=black, thin, circle, inner sep=0.2mm, text=black,
        font=\devfont\fontsize{5}{6}\selectfont]
    at (7.5mm, \padabot pt) {#3};
}

% Xiù lane: CJK character in a thin circle + ordinal number
% #1 = degree position (bottom of span), #2 = xiù character, #3 = ordinal (1-28)
\newcommand{\xiulane}[3]{%
  \pgfmathsetmacro{\xiubot}{#1 * (\cardheight-20mm)/10}%
  \node[anchor=south west, draw=black, thin, circle, inner sep=0.2mm, text=black,
        font=\cjkfont\fontsize{5}{6}\selectfont] (xiu#3)
    at (10mm, \xiubot pt) {#2};
  \node[anchor=west, text=black, inner sep=0pt,
        font=\cardfont\fontsize{4}{5}\selectfont]
    at ([xshift=0.25mm]xiu#3.east) {#3};
}

% Solar term at bottom of decan (above bounds label)
...
\minorcard[{\playingcardmarks{black}{2}{♣}{1.0}{1.0}
  ...
  \decanticks{0}
  % Solar term: 春分 Spring Equinox at 0°, lane left of hexagrams
  \node[anchor=west, text=black, inner sep=0pt, rotate=90,
        font=\fontsize{5}{6}\selectfont]
    at (\cardwidth-11mm, 0pt) {{\cjkfont 春分}\hspace{0.3em}{\cardfont Chūnfēn}\hspace{0.6em}{\cardfont Spring Equinox}};
  % Pentad: 玄鳥至 Swallows Arrive at 0°
  \pgfmathsetmacro{\pentadA}{0 * (\cardheight-20mm)/10}%
  \node[anchor=west, text=black, inner sep=0pt, rotate=90,
        font=\fontsize{4}{5}\selectfont]
    at (\cardwidth-9mm, \pentadA pt) {{\cjkfont 玄鳥至}\hspace{0.3em}{\cardfont Xuánniǎo zhì}\hspace{0.6em}{\cardfont Swallows Arrive}};
  \boundsquare{0}{Jupiter}
  % Pentad: 雷乃發聲 Thunder Sounds at 5°
  \pgfmathsetmacro{\pentadB}{5 * (\cardheight-20mm)/10}%
  \node[anchor=west, text=black, inner sep=0pt, rotate=90,
        font=\fontsize{4}{5}\selectfont]
    at (\cardwidth-9mm, \pentadB pt) {{\cjkfont 雷乃發聲}\hspace{0.3em}{\cardfont Léi nǎi fāshēng}\hspace{0.6em}{\cardfont Thunder Sounds}};
  \boundsquare{6}{Venus}
  % Pādas of Uttara Bhādrapadā (#26): दू थ झ ञ
  \padasyllable{0}{0.933}{दू}
  \padasyllable{0.933}{4.267}{थ}
  \padasyllable{4.267}{7.6}{झ}
  \padasyllable{7.6}{10}{ञ}
  % Xiù lane: 室 Shì (0°–3.4°), 壁 Bì (3.4°–10°)
  \xiulane{0}{室}{13}
  \xiulane{3.4}{壁}{14}
  \fixedstar{9.583}{Algenib}
  % Small hexagram 40 (解) centered on 4th tick
  \pgfmathsetmacro{\hextick}{3 * (\cardheight-20mm)/10}%
  \begin{scope}[shift={(\cardwidth-17mm, \hextick pt)}, line width=0.6mm, line cap=butt]
  ...
  \begin{scope}[shift={(\cardwidth-17mm, \hextickb pt)}, line cap=butt]
...
\minorcard[{\playingcardmarks{red}{2}{♥}{1.0}{1.0}
  ...
  \decanticks{90}
  \solartermstart{10}{夏至}{Xiàzhì}{Summer Solstice}
  \boundstart{1}{Mars}
...
\minorcard[{\playingcardmarks{black}{2}{♠}{1.0}{1.0}
  ...
  \decanticks{180}
  \solartermstart{16}{秋分}{Qiūfēn}{Autumn Equinox}
  \boundstart{1}{Saturn}
...
\minorcard[{\playingcardmarks{red}{2}{♦}{1.0}{1.0}
  ...
  \decanticks{270}
  \solartermstart{22}{冬至}{Dōngzhì}{Winter Solstice}
  \boundstart{1}{Mercury}
...
\minorcard[{\playingcardmarks{black}{3}{♣}{1.0}{1.0}
  ...
  \node[anchor=south west, text=black, inner sep=0pt]
    at (13mm, \boundslow pt + 0.5mm) {\makebox[0.6em][c]{\symbserif\fontsize{5}{6}\selectfont ☿}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 3.}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont \scalebox{0.7}[1]{Bounds of} Mercury}};
  \node[anchor=north west, text=black, inner sep=0pt]
    at (13mm, \boundslow pt - 0.5mm) {\makebox[0.6em][c]{\symbserif\fontsize{5}{6}\selectfont ♀}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 2.}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont \scalebox{0.7}[1]{Bounds of} Venus}};
...
\minorcard[{\playingcardmarks{black}{4}{♣}{1.0}{1.0}
  ...
  % Nakṣatra/Rāśi boundary: Revatī → Aśvinī / Mīna → Meṣa at 24°16' (4.267°)
  \pgfmathsetmacro{\nakshatrabdy}{4.267 * (\cardheight-20mm)/10}%
  \draw[black, thin] (2mm, \nakshatrabdy pt) -- (12.5mm, \nakshatrabdy pt);
  % Rāśi (left side) — inline romanization
  \node[anchor=south west, text=black, inner sep=0pt]
    at (2.5mm, \nakshatrabdy pt + 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ♈}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 1.}\hspace{0.1em}{\devfont\fontsize{5}{6}\selectfont मेष}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont Meṣa}};
  \node[anchor=north west, text=black, inner sep=0pt]
    at (2.5mm, \nakshatrabdy pt - 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ♓}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 12.}\hspace{0.1em}{\devfont\fontsize{5}{6}\selectfont मीन}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont Mīna}};
  % Nakṣatra (right side) — with transliteration
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
    at (19.325mm, \nakshatrabdy pt + 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Aśvinī}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (14mm, \nakshatrabdy pt + 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 1.}\hspace{0.1em}{\devfont\fontsize{5}{6}\selectfont अश्विनी}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont The Physicians}};
  \node[anchor=north west, text=black, inner sep=0pt]
    at (14mm, \nakshatrabdy pt - 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 27.}\hspace{0.1em}{\devfont\fontsize{5}{6}\selectfont रेवती}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont The Wealthy}};
  \node[anchor=north west, text=black, inner sep=0pt, xscale=0.48]
    at (18.65mm, \nakshatrabdy pt - 2.25mm) {{\cardfont\fontsize{5}{6}\selectfont Revatī}};
  % Bounds boundary: Saturn starts at 25° (5.0°) + Pentad 15: Rainbows Appear
  \pgfmathsetmacro{\boundsbdy}{5.0 * (\cardheight-20mm)/10}%
  \draw[black, thin] (2mm, \boundsbdy pt) -- (12.5mm, \boundsbdy pt);
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
    at (7mm, \boundsbdy pt + 4.5mm) {{\cardfont\fontsize{5}{6}\selectfont Hóng shǐ xiàn}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (2.5mm, \boundsbdy pt + 2.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☉}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 15.}\hspace{0.1em}{\cjkfont\fontsize{5}{6}\selectfont 虹始見}};\node[anchor=south west, text=black, inner sep=0pt, xscale=0.65]
    at (13mm, \boundsbdy pt + 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Rainbows Appear}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (2.5mm, \boundsbdy pt + 0.5mm) {\makebox[0.6em][c]{\symbserif\fontsize{5}{6}\selectfont ♄}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 5.}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont \scalebox{0.7}[1]{Bounds of} Saturn}};
  % Manzil boundary: Baṭn al-Ḥūt → Sharaṭayn at 25°09' (5.15°)
  \pgfmathsetmacro{\manzilbdy}{5.15 * (\cardheight-20mm)/10}%
  \pgfmathsetmacro{\manzilhigh}{\manzilbdy + 8.8/25.4*72.27}%
  \draw[black, thin] (2mm, \manzilbdy pt) -- (2.5mm, \manzilbdy pt) -- (3mm, \manzilhigh pt) -- (12.5mm, \manzilhigh pt);
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
    at (7mm, \manzilhigh pt + 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Sharaṭayn}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (2.5mm, \manzilhigh pt + 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 1.}\hspace{0.1em}{\arabfont\fontsize{5}{6}\selectfont \beginR شرطين\endR}};
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.65]
    at (13mm, \manzilhigh pt + 0.5mm) {{\cardfont\fontsize{5}{6}\selectfont The Two Signs}};
  \node[anchor=north west, text=black, inner sep=0pt]
    at (2.5mm, \manzilhigh pt - 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 28.}\hspace{0.1em}{\arabfont\fontsize{5}{6}\selectfont \beginR بطن الحوت\endR}};
  \node[anchor=north west, text=black, inner sep=0pt, xscale=0.65]
    at (15mm, \manzilhigh pt - 0.5mm) {{\cardfont\fontsize{5}{6}\selectfont Belly of the Fish}};
  \node[anchor=north west, text=black, inner sep=0pt, xscale=0.48]
    at (7mm, \manzilhigh pt - 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Baṭn al-Ḥūt}};
  % Xiù boundary: Kuí → Lóu at 27°02' (7.033°)
  \pgfmathsetmacro{\xiubdy}{7.033 * (\cardheight-20mm)/10}%
  \draw[black, thin] (2mm, \xiubdy pt) -- (19.5mm, \xiubdy pt);
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
    at (14.25mm, \xiubdy pt + 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Lóu}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (9.5mm, \xiubdy pt + 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 16.}\hspace{0.1em}{\cjkfont\fontsize{5}{6}\selectfont 婁}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont Bond}};
  \node[anchor=north west, text=black, inner sep=0pt]
    at (9.5mm, \xiubdy pt - 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 15.}\hspace{0.1em}{\cjkfont\fontsize{5}{6}\selectfont 奎}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont Legs}};
  \node[anchor=north west, text=black, inner sep=0pt, xscale=0.48]
    at (14.25mm, \xiubdy pt - 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Kuí}};
...
\minorcard[{\playingcardmarks{red}{4}{♥}{1.0}{1.0}
  ...
  \decanticks{110}
  \fixedstar{0.667}{Castor}
  \fixedstar{3.633}{Pollux}
  \fixedstar{6.2}{Procyon}
...
\minorcard[{\playingcardmarks{black}{5}{♣}{1.0}{1.0}
  ...
  \decanticks{120}
  \solartermstart{12}{大暑}{Dàshǔ}{Major Heat}
  \boundstart{1}{Jupiter}
  % Bounds boundary: Jupiter → Venus at 6° Leo (6.0°)
  \pgfmathsetmacro{\boundsbdy}{6.0 * (\cardheight-20mm)/10}%
  \pgfmathsetmacro{\boundslow}{\boundsbdy - 2.0/25.4*72.27}%
  \draw[black, thin] (2mm, \boundsbdy pt) -- (2.5mm, \boundsbdy pt) -- (3mm, \boundslow pt) -- (12.5mm, \boundslow pt);
  \node[anchor=south west, text=black, inner sep=0pt]
    at (2.5mm, \boundslow pt + 0.5mm) {\makebox[0.6em][c]{\symbserif\fontsize{5}{6}\selectfont ♀}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 2.}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont \scalebox{0.7}[1]{Bounds of} Venus}};
  \fixedstar{6.15}{Theta Cancri}
  \fixedstar{7.817}{Praesepe}
  % Manzil boundary: Nathra → Ṭarfa at 08°01' Leo (8.017°)
  \pgfmathsetmacro{\manzilbdy}{8.017 * (\cardheight-20mm)/10}%
  \pgfmathsetmacro{\manzilhigh}{\manzilbdy + 3.0/25.4*72.27}%
  \draw[black, thin] (2mm, \manzilbdy pt) -- (2.5mm, \manzilbdy pt) -- (3mm, \manzilhigh pt) -- (12.5mm, \manzilhigh pt);
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
    at (7mm, \manzilhigh pt + 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Ṭarfa}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (2.5mm, \manzilhigh pt + 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 9.}\hspace{0.1em}{\arabfont\fontsize{5}{6}\selectfont \beginR الطرفة\endR}};
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.65]
    at (13mm, \manzilhigh pt + 0.5mm) {{\cardfont\fontsize{5}{6}\selectfont The Glance}};
  \node[anchor=north west, text=black, inner sep=0pt]
    at (2.5mm, \manzilhigh pt - 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 8.}\hspace{0.1em}{\arabfont\fontsize{5}{6}\selectfont \beginR النثرة\endR}};
  \node[anchor=north west, text=black, inner sep=0pt, xscale=0.65]
    at (13mm, \manzilhigh pt - 0.5mm) {{\cardfont\fontsize{5}{6}\selectfont The Gap}};
  \node[anchor=north west, text=black, inner sep=0pt, xscale=0.48]
    at (7mm, \manzilhigh pt - 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Nathra}};
...
\minorcard[{\playingcardmarks{red}{5}{♥}{1.0}{1.0}
  ...
  \decanticks{210}
  \solartermstart{18}{霜降}{Shuāngjiàng}{Frost's Descent}
  \boundstart{1}{Mars}
...
\minorcard[{\playingcardmarks{black}{5}{♠}{1.0}{1.0}
  ...
  \decanticks{300}
  \solartermstart{24}{大寒}{Dàhán}{Major Cold}
  \boundstart{1}{Mercury}
  \fixedstar{2.2}{Altair}
  \fixedstar{4.283}{Giedi Prima}
  \fixedstar{4.467}{Dabih}
...
\minorcard[{\playingcardmarks{red}{5}{♦}{1.0}{1.0}
  ...
  \decanticks{30}
  \solartermstart{6}{穀雨}{Gǔyǔ}{Grain Rain}
  \boundstart{1}{Venus}
  \fixedstar{0.833}{Mirach}
  \fixedstar{4.4}{Sheratan}
  \fixedstar{8.083}{Hamal}
...
\minorcard[{\playingcardmarks{black}{6}{♣}{1.0}{1.0}
  ...
  \decanticks{130}
  \fixedstar{0.733}{Delta Hydrae}
  % Xiù boundary: Jǐng → Guǐ at 10°45' Leo (0.75°) — diagonal UP just above star
  \pgfmathsetmacro{\xiubdya}{0.75 * (\cardheight-20mm)/10}%
  \pgfmathsetmacro{\xiuhigha}{\xiubdya + 5.0/25.4*72.27}%
  \draw[black, thin] (2mm, \xiubdya pt) -- (2.5mm, \xiubdya pt) -- (3mm, \xiuhigha pt) -- (12.5mm, \xiuhigha pt);
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
    at (7mm, \xiuhigha pt + 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Guǐ}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (2.5mm, \xiuhigha pt + 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 23.}\hspace{0.1em}{\cjkfont\fontsize{5}{6}\selectfont 鬼}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont Ghost}};
  \node[anchor=north west, text=black, inner sep=0pt]
    at (2.5mm, \xiuhigha pt - 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 22.}\hspace{0.1em}{\cjkfont\fontsize{5}{6}\selectfont 井}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont Well}};
  \node[anchor=north west, text=black, inner sep=0pt, xscale=0.48]
    at (7mm, \xiuhigha pt - 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Jǐng}};
  % Nakṣatra boundary: Puṣya → Āśleṣā at 10°56' Leo (0.933°) — diagonal UP above xiù
  \pgfmathsetmacro{\nakshatrabdy}{0.933 * (\cardheight-20mm)/10}%
  \pgfmathsetmacro{\nakshatrahigh}{\nakshatrabdy + 12.0/25.4*72.27}%
  \draw[black, thin] (2mm, \nakshatrabdy pt) -- (2.5mm, \nakshatrabdy pt) -- (3mm, \nakshatrahigh pt) -- (12.5mm, \nakshatrahigh pt);
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
    at (7mm, \nakshatrahigh pt + 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Āśleṣā}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (2.5mm, \nakshatrahigh pt + 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 9.}\hspace{0.1em}{\devfont\fontsize{5}{6}\selectfont आश्लेषा}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont The Embracer}};
  \node[anchor=north west, text=black, inner sep=0pt]
    at (2.5mm, \nakshatrahigh pt - 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 8.}\hspace{0.1em}{\devfont\fontsize{5}{6}\selectfont पुष्य}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont The Nourisher}};
  \node[anchor=north west, text=black, inner sep=0pt, xscale=0.48]
    at (7mm, \nakshatrahigh pt - 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Puṣya}};
  % Bounds boundary: Venus → Saturn at 11° Leo (1.0°) — diagonal UP above nakṣatra
  \pgfmathsetmacro{\boundsbdya}{1.0 * (\cardheight-20mm)/10}%
  \pgfmathsetmacro{\boundshigha}{\boundsbdya + 18.0/25.4*72.27}%
  \draw[black, thin] (2mm, \boundsbdya pt) -- (2.5mm, \boundsbdya pt) -- (3mm, \boundshigha pt) -- (12.5mm, \boundshigha pt);
  \node[anchor=south west, text=black, inner sep=0pt]
    at (2.5mm, \boundshigha pt + 0.5mm) {\makebox[0.6em][c]{\symbserif\fontsize{5}{6}\selectfont ♄}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 3.}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont \scalebox{0.7}[1]{Bounds of} Saturn}};
  \node[anchor=north west, text=black, inner sep=0pt]
    at (2.5mm, \boundshigha pt - 0.5mm) {\makebox[0.6em][c]{\symbserif\fontsize{5}{6}\selectfont ♀}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 2.}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont \scalebox{0.7}[1]{Bounds of} Venus}};
  % Xiù/Cì boundary: Guǐ → Liǔ / Chúnhuǒ at 12°15' Leo (2.25°)
  \pgfmathsetmacro{\xiubdyb}{2.25 * (\cardheight-20mm)/10}%
  \pgfmathsetmacro{\xiuhighb}{\xiubdyb + 6.0/25.4*72.27}%
  \draw[black, thin] (2mm, \xiubdyb pt) -- (2.5mm, \xiubdyb pt) -- (3mm, \xiuhighb pt) -- (12.5mm, \xiuhighb pt);
  % Cì (left side)
  \node[anchor=south west, text=black, inner sep=0pt]
    at (2.5mm, \xiuhighb pt + 0.5mm) {\makebox[0.6em][c]{\symbserif\fontsize{5}{6}\selectfont ♃}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 8.}\hspace{0.1em}{\cjkfont\fontsize{5}{6}\selectfont 鶉火}};
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.65]
    at (13mm, \xiuhighb pt + 0.5mm) {{\cardfont\fontsize{5}{6}\selectfont Quail Fire}};
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
    at (7mm, \xiuhighb pt + 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Chúnhuǒ}};
  % Xiù (right side)
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
    at (28.65mm, \xiuhighb pt + 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Liǔ}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (24mm, \xiuhighb pt + 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 24.}\hspace{0.1em}{\cjkfont\fontsize{5}{6}\selectfont 柳}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont Willow}};
  \node[anchor=north west, text=black, inner sep=0pt]
    at (24mm, \xiuhighb pt - 0.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 23.}\hspace{0.1em}{\cjkfont\fontsize{5}{6}\selectfont 鬼}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont Ghost}};
  \node[anchor=north west, text=black, inner sep=0pt, xscale=0.48]
    at (28.65mm, \xiuhighb pt - 2.5mm) {{\cardfont\fontsize{5}{6}\selectfont Guǐ}};
  \fixedstar{8.3}{Alterf}
  % Bounds boundary: Saturn → Mercury at 18° Leo (8.0°) — diagonal DOWN below Alterf
  \pgfmathsetmacro{\boundsbdyb}{8.0 * (\cardheight-20mm)/10}%
  \pgfmathsetmacro{\boundslowb}{\boundsbdyb - 2.0/25.4*72.27}%
  \draw[black, thin] (2mm, \boundsbdyb pt) -- (2.5mm, \boundsbdyb pt) -- (3mm, \boundslowb pt) -- (12.5mm, \boundslowb pt);
  \node[anchor=south west, text=black, inner sep=0pt]
    at (2.5mm, \boundslowb pt + 0.5mm) {\makebox[0.6em][c]{\symbserif\fontsize{5}{6}\selectfont ☿}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 4.}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont \scalebox{0.7}[1]{Bounds of} Mercury}};
  \node[anchor=north west, text=black, inner sep=0pt]
    at (2.5mm, \boundslowb pt - 0.5mm) {\makebox[0.6em][c]{\symbserif\fontsize{5}{6}\selectfont ♄}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 3.}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont \scalebox{0.7}[1]{Bounds of} Saturn}};
...
\minorcard[{\playingcardmarks{black}{7}{♠}{1.0}{1.0}
  ...
  \decanticks{320}
  \boundstart{4}{Mars}
  \fixedstar{3.817}{Sadalsuud}
  \fixedstar{3.967}{Deneb Algedi}
...
\minorcard[{\playingcardmarks{black}{8}{♣}{1.0}{1.0}
  ...
  \decanticks{240}
  \solartermstart{20}{小雪}{Xiǎoxuě}{Minor Snow}
  \boundstart{1}{Jupiter}
  \fixedstar{3.367}{Fang}
...
\minorcard[{\playingcardmarks{red}{8}{♥}{1.0}{1.0}
  ...
  \decanticks{330}
  \solartermstart{2}{雨水}{Yǔshuǐ}{Rain Water}
  \boundstart{1}{Venus}
  \fixedstar{3.783}{Sadalmelik}
  \fixedstar{4.283}{Fomalhaut}
...
\minorcard[{\playingcardmarks{black}{8}{♠}{1.0}{1.0}
  ...
  \decanticks{60}
  \solartermstart{8}{小滿}{Xiǎomǎn}{Grain Buds}
  \boundstart{1}{Mercury}
...
\minorcard[{\playingcardmarks{red}{8}{♦}{1.0}{1.0}
  ...
  \decanticks{150}
  \solartermstart{14}{處暑}{Chǔshǔ}{End of Heat}
  \boundstart{1}{Mercury}
...
\minorcard[{\playingcardmarks{black}{9}{♣}{1.0}{1.0}
  ...
  \decanticks{250}
  \fixedstar{0.183}{Antares}
  \fixedstar{6.583}{Xamidimura}
...
\minorcard[{\playingcardmarks{black}{9}{♠}{1.0}{1.0}
  ...
  \decanticks{70}
  \fixedstar{0.217}{Aldebaran}
  \fixedstar{7.25}{Rigel}
...
\minorcard[{\playingcardmarks{black}{10}{♠}{0.7}{1.0}
  ...
  \fixedstar{4.133}{Meissa}
  \fixedstar{5.1}{Alnitak}
  \fixedstar{9.0}{Polaris}
