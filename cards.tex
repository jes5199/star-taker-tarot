...
\minorcard[{\playingcardmarks{black}{2}{♣}{1.0}{1.0}
  ...
  \node[anchor=south west, text=black, inner sep=0pt]
    at (6.5mm, 7mm) {{\scalebox{1.5}[1]{\rotatebox[origin=c]{90}{\symbfont\fontsize{5}{6}\selectfont\bfseries <}}}\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☽}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 26.}\hspace{0.1em}%
    \sbox0{{\devfont\fontsize{5}{6}\selectfont उत्तर भाद्रपद}}%
    \begin{tabular}[b]{@{}l@{}}
      \resizebox{\wd0}{\totalheight}{\cardfont\fontsize{5}{6}\selectfont Uttara Bhadrapada} \\[-6.5pt]
      {\devfont\fontsize{5}{6}\selectfont उत्तर भाद्रपद}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont Latter Lucky Feet}
    \end{tabular}};
  \node[anchor=south west, text=black, inner sep=0pt]
