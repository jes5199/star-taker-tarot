...
\minorcard[{\playingcardmarks{black}{2}{♣}{1.0}{1.0}
  ...
  % Scheat (Beta Pegasi) — 00°05' Aries (2050)
  \pgfmathsetmacro{\scheatpos}{(5/60) * (\cardheight-20mm)/10}%
  \node[anchor=west, text=black, font=\symbserif\fontsize{6}{7}\selectfont]
    at (13mm, \scheatpos pt) {★};
  \node[anchor=west, text=black, font=\cardfont\fontsize{7}{8}\selectfont]
    at (16mm, \scheatpos pt + 0.25mm) {Scheat};
