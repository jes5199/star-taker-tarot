...
\newcommand{\zdaries}{%
  \node[anchor=center, text=red, font=\symbserif\fontsize{160}{170}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight) {♈};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, \cardheight-6mm) {cardinal fire};
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-13mm) {\tinysulfur};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-13mm) {\tinyfire};
}
% Taurus (Hierophant) — Red-Orange
\newcommand{\zdtaurus}{%
  \node[anchor=center, text=red!50!orange, font=\symbserif\fontsize{160}{170}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight) {♉};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, \cardheight-6mm) {fixed earth};
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-13mm) {\tinysalt};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-13mm) {\tinyearth};
}
% Gemini (Lovers) — Orange
\newcommand{\zdgemini}{%
  \node[anchor=center, text=orange, font=\symbserif\fontsize{160}{170}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight) {♊};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, \cardheight-6mm) {mutable air};
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-13mm) {\tinymercury};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-13mm) {\tinyair};
}
% Cancer (Chariot) — Amber
\newcommand{\zdcancer}{%
  \node[anchor=center, text=yellow!50!orange, font=\symbserif\fontsize{160}{170}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight) {♋};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, \cardheight-6mm) {cardinal water};
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-13mm) {\tinysulfur};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-13mm) {\tinywater};
}
% Leo (Strength) — Yellow
\newcommand{\zdleo}{%
  \node[anchor=center, text=yellow!80!orange, font=\symbserif\fontsize{160}{170}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight) {♌};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, \cardheight-6mm) {fixed fire};
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-13mm) {\tinysalt};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-13mm) {\tinyfire};
}
% Virgo (Hermit) — Yellow-Green
\newcommand{\zdvirgo}{%
  \node[anchor=center, text=yellow!50!green, font=\symbserif\fontsize{160}{170}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight) {♍};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, \cardheight-6mm) {mutable earth};
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-13mm) {\tinymercury};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-13mm) {\tinyearth};
}
% Libra (Justice) — Green
\newcommand{\zdlibra}{%
  \node[anchor=center, text=green!70!black, font=\symbserif\fontsize{160}{170}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight) {♎};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, \cardheight-6mm) {cardinal air};
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-13mm) {\tinysulfur};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-13mm) {\tinyair};
}
% Scorpio (Death) — Turquoise
\newcommand{\zdscorpio}{%
  \node[anchor=center, text=blue!50!green, font=\symbserif\fontsize{160}{170}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight) {♏};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, \cardheight-6mm) {fixed water};
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-13mm) {\tinysalt};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-13mm) {\tinywater};
}
% Sagittarius (Temperance) — Blue
\newcommand{\zdsagittarius}{%
  \node[anchor=center, text=blue, font=\symbserif\fontsize{160}{170}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight) {♐};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, \cardheight-6mm) {mutable fire};
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-13mm) {\tinymercury};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-13mm) {\tinyfire};
}
% Capricorn (Devil) — Indigo
\newcommand{\zdcapricorn}{%
  \node[anchor=center, text=blue!50!violet, font=\symbserif\fontsize{160}{170}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight) {♑};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, \cardheight-6mm) {cardinal earth};
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-13mm) {\tinysulfur};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-13mm) {\tinyearth};
}
% Aquarius (Star) — Violet
\newcommand{\zdaquarius}{%
  \node[anchor=center, text=violet, font=\symbserif\fontsize{160}{170}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight) {♒};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, \cardheight-6mm) {fixed air};
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-13mm) {\tinysalt};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-13mm) {\tinyair};
}
% Pisces (Moon XVIII) — Red-Violet
\newcommand{\zdpisces}{%
  \node[anchor=center, text=red!50!violet, font=\symbserif\fontsize{160}{170}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight) {♓};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, \cardheight-6mm) {mutable water};
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-13mm) {\tinymercury};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-13mm) {\tinywater};
}
