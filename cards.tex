...
% #1 = degree position, #2 = CJK name, #3 = pinyin, #4 = English name
\newcommand{\pentadlane}[4]{%
  \pgfmathsetmacro{\plpos}{#1 * (\cardheight-20mm)/10}%
  \node[anchor=west, text=black, inner sep=0pt, rotate=90,
        font=\fontsize{4}{5}\selectfont]
    at (\cardwidth-9mm, \plpos pt) {{\cjkfont #2}\hspace{0.3em}{\cardfont #3}\hspace{0.6em}{\cardfont #4}};
}
...
\newcommand{\hexagram}[6]{%
  ...
  \pgfmathsetmacro{\hexbotlabel}{max(-4.5, -\hextickpos * 25.4/72.27 + 0.5)}%
