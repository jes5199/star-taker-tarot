...
\newcommand{\alcmercury}{%
  \begin{scope}[shift={(0.5\cardwidth,0.45\cardheight)}, yellow!80!orange, line width=1.5mm]
    % Cross — vertical bar from bottom up to where U begins
    \draw (0,-12mm) -- (0,0mm);
    \draw (-6mm,-6mm) -- (6mm,-6mm); % horizontal bar
    % U (open arc) sitting on top of the cross
    \draw (-7mm,14mm) -- (-7mm,7mm) arc (180:360:7mm) -- (7mm,14mm);
  \end{scope}%
}
