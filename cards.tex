...
\newcommand{\fixedstar}[3][]{%
  \pgfkeys{/fixedstar/.cd, xshift=0mm, rotate label=0, label below=0, #1}%
  ...
  \ifnum\fslabelbelow=1
    ...
    \node[anchor=west, text=black, inner sep=0pt, rotate=-45]
...
% #1 = degree position (bottom of span), #2 = Arabic letter, #3 = ordinal (1-28)
\newcommand{\manzillane}[3]{%
  \pgfmathsetmacro{\manzilbot}{#1 * (\cardheight-20mm)/10}%
  \node[anchor=south west, draw=black, thin, circle, minimum size=3.5mm, inner sep=0pt, text=black,
        font=\kufifont\fontsize{5}{6}\selectfont] (manzil#3)
    at (5mm, \manzilbot pt) {\beginR #2\endR};
  \node[anchor=west, text=black, inner sep=0pt,
        font=\cardfont\fontsize{5}{6}\selectfont] (manzilnum#3)
    at ([xshift=0.25mm]manzil#3.east) {#3};
}
...
\minorcard[{\playingcardmarks{black}{5}{♣}{1.0}{1.0}
  ...
  \fixedstar[label below=1]{7.817}{Praesepe}
  % Solar term and pentads
  \solartermlane{0}{大暑}{Dàshǔ}{Major Heat}
  \pentadlane[0.7]{0}{腐草為螢}{Fǔcǎo wéi yíng}{Decaying Grass Becomes Fireflies}
