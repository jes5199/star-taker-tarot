...
\minorcard[{\playingcardmarks{black}{2}{♣}{1.0}{1.0}
  ...
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
    at (11.5mm, 44.3mm) {{\cardfont\fontsize{5}{6}\selectfont Léi nǎi fāshēng}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (6.5mm, 42.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☉}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 11.}\hspace{0.1em}{\cjkfont\fontsize{5}{6}\selectfont 雷乃發聲}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont Thunder Sounds}};
