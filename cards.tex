...
\minorcard[{\playingcardmarks{black}{2}{♣}{1.0}{1.0}
  ...
  \node[anchor=south west, text=black, inner sep=0pt]
    at (6.5mm, 0.5mm) {{\scalebox{1.5}[1]{\rotatebox[origin=c]{90}{\symbfont\fontsize{5}{6}\selectfont\bfseries <}}}{\symbfont\fontsize{5}{6}\selectfont ☉} {\cardfont\fontsize{5}{6}\selectfont 12 }{\devfont\fontsize{5}{6}\selectfont मीन} {\cardfont\fontsize{5}{6}\selectfont Mīna} {\symbserif\fontsize{5}{6}\selectfont ♓}};
