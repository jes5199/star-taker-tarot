...
% #1 = pada node name (e.g. pada1), #2 = nakṣatra number, #3 = rāśi symbol, #4 = rāśi Devanagari, #5 = rāśi romanization
\newcommand{\nakshatrastart}[5]{%
  \node[anchor=west, text=black, inner sep=0pt,
        font=\fontsize{5}{6}\selectfont]
    at ([xshift=0.25mm]#1.east) {{\cardfont #2}\hspace{0.3em}{\symbfont #3}\hspace{0.1em}{\devfont #4}\hspace{0.1em}{\cardfont #5}};
}
...
\newcommand{\xiulane}[3]{%
  ...
  \node[anchor=south west, draw=black, thin, circle, minimum size=3.5mm, inner sep=0pt, text=black,
    ...
    at (10mm, \xiubot pt) {#2};
  \node[anchor=west, text=black, inner sep=0pt,
        font=\cardfont\fontsize{5}{6}\selectfont] (xiunum#3)
    at ([xshift=0.25mm]xiu#3.east) {#3};
}
% Cì start marker: cì name attached right of xiù ordinal number
% #1 = xiù ordinal number node (e.g. xiunum15), #2 = cì CJK, #3 = cì romanization
\newcommand{\cistart}[3]{%
  \node[anchor=west, text=black, inner sep=0pt,
        font=\fontsize{5}{6}\selectfont]
    at ([xshift=0.3em]#1.east) {{\cjkfont #2}\hspace{0.1em}{\cardfont #3}};
}
