...
% #1=x, #2=y (center), #3=line pattern bottom to top (1=yang, 0=yin)
\newcommand{\drawhexagram}[3]{%
  \begin{scope}[shift={(#1, #2)}, line width=1.5mm, line cap=butt]
    \foreach \type [count=\i from 0] in {#3} {
      \ifnum\type=1
        \draw (-6mm, \i*4mm-10mm) -- (6mm, \i*4mm-10mm);
      \else
        \draw (-6mm, \i*4mm-10mm) -- (-1mm, \i*4mm-10mm);
        \draw (1mm, \i*4mm-10mm) -- (6mm, \i*4mm-10mm);
      \fi
    }
  \end{scope}%
}
...
\newcommand{\zdaries}{%
  ...
  \drawhexagram{0}{0.5\cardheight}{1,1,1,1,0,0}% 大壮 Pisces→Aries
  \drawhexagram{\cardwidth}{0.5\cardheight}{1,1,1,1,1,0}% 夬 Aries→Taurus
}
...
\newcommand{\zdtaurus}{%
  ...
  \drawhexagram{0}{0.5\cardheight}{1,1,1,1,1,0}% 夬 Aries→Taurus
  \drawhexagram{\cardwidth}{0.5\cardheight}{1,1,1,1,1,1}% 乾 Taurus→Gemini
}
...
\newcommand{\zdgemini}{%
  ...
  \drawhexagram{0}{0.5\cardheight}{1,1,1,1,1,1}% 乾 Taurus→Gemini
  \drawhexagram{\cardwidth}{0.5\cardheight}{0,1,1,1,1,1}% 姤 Gemini→Cancer
}
...
\newcommand{\zdcancer}{%
  ...
  \drawhexagram{0}{0.5\cardheight}{0,1,1,1,1,1}% 姤 Gemini→Cancer
  \drawhexagram{\cardwidth}{0.5\cardheight}{0,0,1,1,1,1}% 遯 Cancer→Leo
}
...
\newcommand{\zdleo}{%
  ...
  \drawhexagram{0}{0.5\cardheight}{0,0,1,1,1,1}% 遯 Cancer→Leo
  \drawhexagram{\cardwidth}{0.5\cardheight}{0,0,0,1,1,1}% 否 Leo→Virgo
}
...
\newcommand{\zdvirgo}{%
  ...
  \drawhexagram{0}{0.5\cardheight}{0,0,0,1,1,1}% 否 Leo→Virgo
  \drawhexagram{\cardwidth}{0.5\cardheight}{0,0,0,0,1,1}% 观 Virgo→Libra
}
...
\newcommand{\zdlibra}{%
  ...
  \drawhexagram{0}{0.5\cardheight}{0,0,0,0,1,1}% 观 Virgo→Libra
  \drawhexagram{\cardwidth}{0.5\cardheight}{0,0,0,0,0,1}% 剥 Libra→Scorpio
}
...
\newcommand{\zdscorpio}{%
  ...
  \drawhexagram{0}{0.5\cardheight}{0,0,0,0,0,1}% 剥 Libra→Scorpio
  \drawhexagram{\cardwidth}{0.5\cardheight}{0,0,0,0,0,0}% 坤 Scorpio→Sagittarius
}
...
\newcommand{\zdsagittarius}{%
  ...
  \drawhexagram{0}{0.5\cardheight}{0,0,0,0,0,0}% 坤 Scorpio→Sagittarius
  \drawhexagram{\cardwidth}{0.5\cardheight}{1,0,0,0,0,0}% 复 Sagittarius→Capricorn
}
...
\newcommand{\zdcapricorn}{%
  ...
  \drawhexagram{0}{0.5\cardheight}{1,0,0,0,0,0}% 复 Sagittarius→Capricorn
  \drawhexagram{\cardwidth}{0.5\cardheight}{1,1,0,0,0,0}% 临 Capricorn→Aquarius
}
...
\newcommand{\zdaquarius}{%
  ...
  \drawhexagram{0}{0.5\cardheight}{1,1,0,0,0,0}% 临 Capricorn→Aquarius
  \drawhexagram{\cardwidth}{0.5\cardheight}{1,1,1,0,0,0}% 泰 Aquarius→Pisces
}
...
\newcommand{\zdpisces}{%
  ...
  \drawhexagram{0}{0.5\cardheight}{1,1,1,0,0,0}% 泰 Aquarius→Pisces
  \drawhexagram{\cardwidth}{0.5\cardheight}{1,1,1,1,0,0}% 大壮 Pisces→Aries
}
