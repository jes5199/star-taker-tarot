...
\newcommand{\alcmercury}{%
  ...
  \end{scope}%
  % Vertical JOKER below the numeral, left side
  \foreach \letter/\i in {J/0,O/1,K/2,E/3,R/4} {
    \node[anchor=center, text=black, font=\indexfont\bfseries\fontsize{12}{14}\selectfont]
      at (2.5mm, \cardheight-11mm-\i*5mm) {\letter};
  }
  % Rotated JOKER above the Hebrew letter, right side (upside down)
  \foreach \letter/\i in {J/0,O/1,K/2,E/3,R/4} {
    \node[anchor=center, rotate=180, text=black, font=\indexfont\bfseries\fontsize{12}{14}\selectfont]
...
\tarotcard{images/a-01}{\Romanbar{I}}{The Magician}{ב}\hfill
