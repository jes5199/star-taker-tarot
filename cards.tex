...
\newcommand{\fixedstar}[3][]{%
  \pgfkeys{/fixedstar/.cd, xshift=0mm, rotate label=0, label below=0, label yshift=0mm, #1}%
  ...
  \ifnum\fslabelbelow=1
    ...
    \node[anchor=west, text=black, inner sep=0pt, rotate=\fsrotate, yshift=\fslabelyshift]
...
\newcommand{\rashistart}[4]{%
  \node[anchor=west, text=black, inner sep=0pt,
        font=\fontsize{5}{6}\selectfont]
    at ([xshift=0.25mm]#1.east) {{\symbfont #2}\hspace{0.1em}{\devfont #3}\hspace{0.1em}{\cardfont #4}};
}
...
\minorcard[{\playingcardmarks{black}{6}{♣}{1.0}{1.0}
  ...
  \pentadlane[0.7]{0}{大雨時行}{Dàyǔ shí xíng}{Heavy Rains Sometimes Fall}
...
\minorcard[{\playingcardmarks{red}{7}{♥}{1.0}{1.0}
  ...
  \pentadlane[0.45]{5}{雉入大水為蜃}{Zhì rù dàshuǐ wéi shèn}{Pheasants Become Mirages}
  % Hexagrams
...
\minorcard[{\playingcardmarks{red}{8}{♥}{1.0}{1.0}
  ...
  % Pādas: Dhaniṣṭhā 4 (गे), then Śatabhiṣā 1-3 (गो सा सी) — nakṣatra 24 starts at 0.933°
  \padasyllable{0}{0.933}{गे}
...
\minorcard[{\playingcardmarks{black}{9}{♣}{1.0}{1.0}
  ...
  \pentadlane[0.65]{0}{閉塞而成冬}{Bìsè ér chéng dōng}{Winter Seals the Earth}
  \pentadlane[0.6]{5}{鶡鴠不鳴}{Hédàn bù míng}{Pheasants No Longer Crow}
  % Hexagrams
...
\minorcard[{\playingcardmarks{red}{9}{♥}{1.0}{1.0}
  ...
  % Pādas: Śatabhiṣā 4 (सी) continues, then सू @0.933°, Pūrva Bhādrapadā (#25) starts @4.267°
  \padasyllable{0}{0.933}{सी}
  \padasyllable{0.933}{4.267}{सू}
  \padasyllable[solid]{4.267}{7.587}{से}
  \nakshatrastart{pada\thepadactr}{25}{}{}{}
  \padasyllable{7.587}{10}{सो}
...
\minorcard[{\playingcardmarks{red}{10}{♥}{0.7}{1.0}
  ...
  % Pādas: Pūrva Bhādrapadā cont. (सो), then दा @0.907°, दी @4.227°, Uttara Bhādrapadā (#26) @7.6°
  \padasyllable{0}{0.907}{सो}
  \padasyllable{0.907}{4.227}{दा}
  \padasyllable{4.227}{7.6}{दी}
  \padasyllable[solid]{7.6}{10}{दू}
  \nakshatrastart{pada\thepadactr}{26}{}{}{}
  % Rāśi boundary: Mīna starts at 24°16' Pisces (4.267°) — rotated to avoid crowding
  \node[anchor=south west, text=black, inner sep=0pt, rotate=90,
        font=\fontsize{5}{6}\selectfont]
    at ([xshift=3.5mm]pada\thepadactr.east) {{\symbfont ♓}\hspace{0.1em}{\devfont मीन}\hspace{0.1em}{\cardfont Mīna}};
