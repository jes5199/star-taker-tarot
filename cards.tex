...
\minorcard[{\playingcardmarks{black}{2}{♣}{1.0}{1.0}
  ...
  \node[anchor=west, rotate=90, text=black]
    at (7mm, 0.5mm) {{\cjkfont\fontsize{6}{7}\selectfont 春分} {\cardfont\fontsize{6}{7}\selectfont Spring Equinox}};
  % 玄鳥至 Swallows arrive at 0°
  \draw[black, thick] (10.5mm, 0) -- (12mm, 0);
  \node[anchor=west, rotate=90, text=black]
    at (11mm, 0.5mm) {{\cjkfont\fontsize{6}{7}\selectfont 玄鳥至} {\cardfont\fontsize{6}{7}\selectfont Swallows arrive}};
  % 雷乃發聲 Thunder sounds at 5°
  \draw[black, thick] (6.5mm, \fivedegs pt) -- (8mm, \fivedegs pt);
  \node[anchor=west, rotate=90, text=black]
    at (7mm, \fivedegs pt + 0.5mm) {{\cjkfont\fontsize{6}{7}\selectfont 雷乃發聲} {\cardfont\fontsize{6}{7}\selectfont Thunder sounds}};
  % Xiù boundary at 03°24' Aries: 室 Shì (Encampment) ends, 壁 Bì (Wall) starts
  \pgfmathsetmacro{\xiuboundary}{(3 + 24/60) * (\cardheight-20mm)/10}%
  \draw[black, thick] (14.5mm, \xiuboundary pt) -- (16mm, \xiuboundary pt);
  \node[anchor=west, rotate=90, text=black]
    at (15mm, \xiuboundary pt + 0.5mm) {{\cjkfont\fontsize{6}{7}\selectfont 壁} {\cardfont\fontsize{6}{7}\selectfont 14 Wall}};
  \node[anchor=east, rotate=90, text=black]
    at (15mm, \xiuboundary pt - 0.5mm) {{\cardfont\fontsize{6}{7}\selectfont 13 Encampment} {\cjkfont\fontsize{6}{7}\selectfont 室}};
