...
\minorcard[{\playingcardmarks{black}{2}{♣}{1.0}{1.0}
  ...
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
    at (11mm, 23.3mm) {{\cardfont\fontsize{5}{6}\selectfont Xuánniǎo zhì}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (6.5mm, 21.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☉}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 10.}\hspace{0.1em}{\cjkfont\fontsize{5}{6}\selectfont 玄鳥至}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont Swallows Arrive}};
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
    at (11mm, 20.05mm) {{\cardfont\fontsize{5}{6}\selectfont Chūnfēn}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (6.5mm, 18mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☉}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 4.}\hspace{0.1em}{\cjkfont\fontsize{5}{6}\selectfont 春分}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont Spring Equinox}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (6.5mm, 15.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☉}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 1.}\hspace{0.1em}{\cardfont\fontsize{5}{6}\selectfont Bounds of Jupiter}};
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
    at (11.5mm, 48.3mm) {{\cardfont\fontsize{5}{6}\selectfont Léi nǎi fāshēng}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (6.5mm, 46.5mm) {\makebox[0.6em][c]{\symbfont\fontsize{5}{6}\selectfont ☉}\makebox[0.6em][r]{\cardfont\fontsize{5}{6}\selectfont 11.}\hspace{0.1em}{\cjkfont\fontsize{5}{6}\selectfont 雷乃發聲}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (11.5mm, 44.5mm) {{\cardfont\fontsize{5}{6}\selectfont Thunder}};
  \node[anchor=south west, text=black, inner sep=0pt]
    at (11.5mm, 42.5mm) {{\cardfont\fontsize{5}{6}\selectfont Sounds}};
  \pgfmathsetmacro{\midtick}{5 * (\cardheight-20mm)/10}%
  \draw[black, thin] (2mm, \midtick pt) -- (16.5mm, \midtick pt);
  \draw[black, thin] (6.5mm, 15mm) -- (16.5mm, 15mm);
  \draw[black, thin] (6.5mm, 15mm) -- (0, 0);
  \node[anchor=south west, text=black, inner sep=0pt, xscale=0.48]
