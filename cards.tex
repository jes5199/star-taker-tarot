...
% #1 = optional TikZ keys for scope (e.g. rotate=90 for vertical layout)
% #2 = xiù ordinal number node (e.g. xiunum15), #3 = cì CJK, #4 = pinyin, #5 = English gloss
\newcommand{\cistart}[5][]{%
  \def\cistart@keys{#1}%
  \def\cistart@empty{}%
  \ifx\cistart@keys\cistart@empty
    \node[anchor=west, text=black, inner sep=0pt,
          font=\fontsize{5}{6}\selectfont] (cihanzi#2)
      at ([xshift=0.3em]#2.east) {{\cjkfont #3}};
    \node[anchor=south west, text=black, inner sep=0pt,
...
\minorcard[{\playingcardmarks{red}{2}{♥}{1.0}{1.0}
  ...
  \xiulane{6.75}{井}{22}
  \cistart[rotate=90, yshift=-1mm]{xiunum22}{鶉首}{Chúnshǒu}{Quail Head}
  % Fixed stars
