...
\newcommand{\boundsquare}[2]{%
  ...
  \node[anchor=south west, draw=black, thin, inner sep=0.3mm, text=black,
        font=\symbserif\fontsize{4}{5}\selectfont]
...
\newcommand{\padasyllable}[3]{%
  ...
  \node[anchor=south west, draw=black, thin, circle, inner sep=0.2mm, text=black,
        font=\devfont\fontsize{4}{5}\selectfont]
    at (7.5mm, \padabot pt) {#3};
}

% Xiù lane: CJK character in a thin circle
% #1 = degree position (bottom of span), #2 = xiù character
\newcommand{\xiulane}[2]{%
  \pgfmathsetmacro{\xiubot}{#1 * (\cardheight-20mm)/10}%
  \node[anchor=south west, draw=black, thin, circle, inner sep=0.2mm, text=black,
        font=\cjkfont\fontsize{4}{5}\selectfont]
    at (10mm, \xiubot pt) {#2};
}
