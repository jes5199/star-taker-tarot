...
% #1 = optional yshift for ordinal number, #2 = degree position, #3 = Arabic letter, #4 = ordinal (1-28)
\newcommand{\manzillane}[4][0mm]{%
  ...
  \node[anchor=west, text=black, inner sep=0pt, yshift=#1,
        font=\cardfont\fontsize{5}{6}\selectfont] (manzilnum#4)
    at ([xshift=-1.5mm]manzil#4.east) {#4};
}
