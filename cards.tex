...
% #1 = numeral (e.g. 一), #2 = suit name (e.g. 条)
\newcommand{\chinesecardmarks}[2]{%
  \node[anchor=north, text=black, font=\cjkfontgb\fontsize{20}{22}\selectfont,
    inner sep=0pt] at (\cardwidth-4.5mm, \cardheight-4mm) {#1};
  \node[anchor=north, text=black, font=\cjkfontgb\fontsize{20}{22}\selectfont,
    inner sep=0pt] at (\cardwidth-4.5mm, \cardheight-9mm) {#2};
}
