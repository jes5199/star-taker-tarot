...
\newcommand{\drawsmallhexagram}[5]{%
  \begin{scope}[shift={(#1, #2)}, line width=1mm, line cap=butt]
    \foreach \type [count=\i from 0] in {#3} {
      \ifnum\type=1
        \draw (-4mm, \i*2mm-5mm) -- (4mm, \i*2mm-5mm);
      \else
        \draw (-4mm, \i*2mm-5mm) -- (-1.5mm, \i*2mm-5mm);
        \draw (1.5mm, \i*2mm-5mm) -- (4mm, \i*2mm-5mm);
      \fi
    }
    \node[anchor=south, text=black, font=\cardfont\fontsize{7}{8}\selectfont]
      at (0, 4.5mm) {#4};
...
\newcommand{\playingcardmarks}[3]{%
  % Top left — rank above suit
  \node[anchor=north, text=#1, font=\cardfont\fontsize{28}{30}\selectfont,
    inner sep=0pt, xscale=0.8] at (4.5mm, \cardheight-2mm) {#2};
  ...
  \node[anchor=north, text=#1, font=\cardfont\fontsize{28}{30}\selectfont,
    inner sep=0pt, xscale=0.8, rotate=180] at (\cardwidth-4.5mm, 2mm) {#2};
  \node[anchor=north, text=#1, font=\symbfont\fontsize{24}{26}\selectfont,
...
\newcommand{\acewands}{%
  ...
  \end{scope}%
  \node[anchor=center, inner sep=0.5mm, draw=black, thick, rounded corners=1mm]
    at (0.5\cardwidth-22mm, 0.52\cardheight-24mm) {%
      \includegraphics[height=15mm]{images/ring-crop.png}%
    };
  \node[anchor=south west, text=black, font=\cardfont\fontsize{10}{11}\selectfont,
    inner sep=0pt] at (0.5\cardwidth-28mm, 0.52\cardheight-32mm) {25};
  \node[anchor=north, text=black, font=\cardfont\fontsize{17}{19}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight-24mm) {Fire};
  \drawsmallhexagram{0.5\cardwidth}{0.52\cardheight-40mm}{1,0,0,1,0,0}{Zhèn}{Thunder}
...
\newcommand{\acecups}{%
  ...
  \drawsmallhexagram{0.5\cardwidth}{0.52\cardheight-40mm}{1,0,1,1,0,1}{Lí}{Clinging}
  \node[anchor=north, text=black, font=\cardfont\fontsize{11}{13}\selectfont]
...
\newcommand{\aceswords}{%
  ...
  \drawsmallhexagram{0.5\cardwidth}{0.52\cardheight-40mm}{0,1,1,0,1,1}{Duì}{Joyous}
  \node[anchor=north, text=black, font=\cardfont\fontsize{11}{13}\selectfont]
...
\newcommand{\acepentacles}{%
  ...
  \drawsmallhexagram{0.5\cardwidth}{0.52\cardheight-40mm}{0,1,0,0,1,0}{Kǎn}{Abysmal}
  \node[anchor=north, text=black, font=\cardfont\fontsize{11}{13}\selectfont]
