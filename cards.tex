...
\minorcard[{\playingcardmarks{black}{2}{♣}{1.0}{1.0}
  ...
  \node[anchor=south, text=red, font=\symbserif\fontsize{50}{52}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight+2mm) {♂};
  \node[anchor=north, text=red, font=\symbserif\fontsize{50}{52}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight-2mm) {♈};
...
\minorcard[{\playingcardmarks{red}{2}{♥}{1.0}{1.0}
  ...
  \node[anchor=south, text=yellow!50!orange, font=\symbserif\fontsize{50}{52}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight+2mm) {♀};
  \node[anchor=north, text=yellow!50!orange, font=\symbserif\fontsize{50}{52}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight-2mm) {♋};
  \chinesecardmarks[🀈]{二}{万}}]{images/c-02}{Two of Cups}\hfill
\minorcard[{\playingcardmarks{black}{2}{♠}{1.0}{1.0}
  \node[anchor=north, text=black, font=\cardfont\fontsize{11}{13}\selectfont]
    at (0.5\cardwidth, \cardheight-6.5mm) {Choice of Air};
  \node[anchor=south, text=green!70!black, font=\symbserif\fontsize{50}{52}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight+2mm) {☽};
  \node[anchor=north, text=green!70!black, font=\symbserif\fontsize{50}{52}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight-2mm) {♎};
...
\minorcard[{\playingcardmarks{red}{2}{♦}{1.0}{1.0}
  ...
  \node[anchor=south, text=blue!50!violet, font=\symbserif\fontsize{50}{52}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight+2mm) {♃};
  \node[anchor=north, text=blue!50!violet, font=\symbserif\fontsize{50}{52}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight-2mm) {♑};
