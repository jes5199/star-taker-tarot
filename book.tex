...
\fancypagestyle{content}{%
  \fancyhf{}%
  \fancyfoot[C]{\fontsize{7}{8}\selectfont\thepage}%
...
\begin{center}\fontsize{12}{17}\selectfont\itshape
Toward the One\\
...
\begin{flushright}
{\fontsize{7}{9}\selectfont --- universalist Sufi prayer of invocation}
\end{flushright}
...
\begin{center}\fontsize{10}{14}\selectfont\itshape
...
\begin{flushright}
{\fontsize{5.5}{6.5}\selectfont\raggedleft --- The I Ching or Book of Changes,\\translated by Richard Wilhelm,\\rendered into English\\by Cary F. Baynes\par}
\end{flushright}
...
\begin{tikzpicture}
  ...
  \fill[white] (30mm, 51.43mm) circle (12mm);
  % Back cover text
  \node[anchor=center, font=\cardfont\fontsize{28}{34}\selectfont,
        text=black, text width=45mm, align=center]
    at (30mm, 51.43mm) {written\\in the\\stars};
\end{tikzpicture}
