...
\usepackage[paperwidth=70mm, paperheight=120mm, margin=0mm, headsep=0pt, headheight=0pt, footskip=0pt]{geometry}
\usepackage{tikz}
\usepackage{fontspec}
...
\setmainfont{Gentium Book Basic}[Scale=0.82]
\usepackage{leading}
\leading{9.3pt}
...
\titleformat{\chapter}[display]
  {\cardfont\fontsize{12}{14}\selectfont\centering}{}{0pt}{}
\renewcommand{\chaptername}{}
\newcommand{\numchapter}[2]{%
  \chapter*{{\fontsize{9}{11}\selectfont #1}\\[1mm] #2}%
...
\newcommand{\partpage}[2][]{%
  ...
  \noindent
  \begin{tikzpicture}
    \useasboundingbox (0,0) rectangle (70mm, 120mm);
    \clip (0,0) rectangle (70mm, 120mm);
    \foreach \a in {0,5,...,355} {
      \foreach \s in {0,1,...,19} {
        \pgfmathsetmacro{\op}{1 - \s/19}%
        \pgfmathsetmacro{\startrad}{5 + \s*2.5}%
        \draw[black, thin, opacity=\op]
          (35mm, 60mm) ++(\a:\startrad mm) -- ++(\a:2.5mm);
      }
    }
    \fill[white] (35mm, 60mm) circle (12mm);
    \node[anchor=center, font=\cardfont\fontsize{33}{40}\selectfont,
          text=black, text width=52mm, align=center]
      at (35mm, 60mm) {#2};
  \end{tikzpicture}
  ...
  \fi
  \newpage
  \newgeometry{paperwidth=60mm, paperheight=102.86mm, margin=5mm, top=7mm, bottom=9mm, footskip=5mm}
  \pagestyle{content}
}
\titleformat{\section}
  {\cardfont\fontsize{8}{10}\selectfont\centering}{}{0pt}{}
\titlespacing*{\chapter}{0pt}{5mm}{3mm}
\titlespacing*{\section}{0pt}{2mm}{1mm}

% Tiny TOC formatting
\usepackage{tocloft}
\renewcommand{\cftchapfont}{\cardfont\fontsize{7}{9}\selectfont}
\renewcommand{\cftchappagefont}{\fontsize{7}{9}\selectfont}
\renewcommand{\cftsecfont}{\fontsize{6}{8}\selectfont}
\renewcommand{\cftsecpagefont}{\fontsize{6}{8}\selectfont}
\renewcommand{\cfttoctitlefont}{\cardfont\fontsize{12}{14}\selectfont\centering}
\setlength{\cftbeforechapskip}{1mm}
\setlength{\cftbeforesecskip}{0.5mm}
\setlength{\cftsecindent}{3mm}
\renewcommand{\cftdotsep}{2}
\renewcommand{\cftpartfont}{\cardfont\fontsize{8}{10}\selectfont}
\renewcommand{\cftpartpagefont}{\fontsize{8}{10}\selectfont}
\setlength{\cftbeforepartskip}{2mm}
...
\begin{tikzpicture}
  ...
  \fill[white] (35mm, 60mm) circle (14mm);
  % Title text
  \node[anchor=center, font=\cardfont\fontsize{46}{50}\selectfont,
        text=black, text width=65mm, align=center]
    at (35mm, 60mm) {Star\\Taker\\Tarot};
\end{tikzpicture}
...
\begin{tikzpicture}
  \useasboundingbox (0,0) rectangle (70mm, 120mm);
  % Title at top
  \node[anchor=north, font=\cardfont\fontsize{23}{28}\selectfont,
        text=black, text width=58mm, align=center]
    at (35mm, 113mm) {Star\\Taker\\Tarot};
  % "by" in the middle
  \node[anchor=center, font=\cardfont\fontsize{12}{16}\selectfont,
        text=black, text width=58mm, align=center]
    at (35mm, 60mm) {by};
  % Author and numeral at bottom
  \node[anchor=south, font=\cardfont\fontsize{12}{16}\selectfont,
        text=black, text width=58mm, align=center]
    at (35mm, 7mm) {Jes\\Annalemma\\Haze Janvir\\Dolan-Wolfe\\I{\reversedC Ↄ}{\reversedC Ↄ}CXCIX};
\end{tikzpicture}
...
\begin{tikzpicture}
  \useasboundingbox (0,0) rectangle (70mm, 120mm);
  \node[anchor=center, font=\cardfont\fontsize{9}{14}\selectfont,
        text=black, text width=56mm, align=center]
    at (35mm, 60mm) {to {\cuneiform 𒀭𒈹}\kern1pt, Queen of Heaven\\[4mm]and to the muse who inspires\\all creation\\[4mm]and to my child Isaac\\who keeps my brain busy};
\end{tikzpicture}
...
{\fontsize{9}{10.3}\selectfont\itshape
...
\begin{center}\fontsize{14}{20}\selectfont\itshape
Toward the One\\
...
\begin{flushright}
{\fontsize{6.5}{7.5}\selectfont\raggedleft --- The I Ching or Book of Changes,\\translated by Richard Wilhelm,\\rendered into English\\by Cary F. Baynes\par}
\end{flushright}
...
\begin{tikzpicture}
  ...
  \node[anchor=center, font=\cardfont\fontsize{33}{40}\selectfont,
        text=black, text width=52mm, align=center]
    at (35mm, 60mm) {written\\in the\\stars};
\end{tikzpicture}
