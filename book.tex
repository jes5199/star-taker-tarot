...
The oldest such system is the I Ching, which originated in the Yellow River valley of China, around 1050 BCE. In this system, the two fundamental bits are yang lines and yin lines, the active and passive elements. A remarkably similar system developed in West Africa where it is known as Ifá (or Fa, or Afa), and was transmitted to the Arab world where it was called \textit{ilm al-raml} (``the science of sand''), and eventually reached medieval Europe where it became Geomancy. In this system, active and passive elements are marked as single (odd) or paired (even) dots.
