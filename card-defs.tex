...
\newcommand{\cardCfourteen}[1]{%
  ...
  % Four hexagrams along the bottom, King Wen 21-24, alternating outlined (white) / filled (black)
  % Same sizing/spacing as prior court cards: 4mm wide, centers 18/26/34/42 at y=7mm
  % ䷔ Shì Hé (Biting Through) — outlined
...
\newcommand{\cardPeleven}[1]{%
  ...
  % Four hexagrams along the bottom, King Wen 5-8, alternating outlined (white) / filled (black)
  % Tighter-packed variant: 4mm wide, centers at x=15/25/35/45 (10mm spacing)
  % ䷄ Xū (Waiting) — outlined
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
...
\newcommand{\cardPtwelve}[1]{%
  ...
  \end{scope}
  % Upper hexagram (䷃ Méng / Youthful Folly, pattern 0,1,0,0,0,1) — rendered all-filled (pip-card "inside decan" style)
  \begin{scope}[shift={(\cardwidth-5mm, 60mm)}, line cap=butt]
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 4.5mm) {Méng};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{5}\selectfont, align=center]
      at (0, -4.5mm) {Youthful\\Folly};
  \end{scope}
  % Lower hexagram (䷂ Zhūn / Sprouting, pattern 1,0,0,0,1,0) — rendered all-outlined (pip-card "outside decan" style)
...
\newcommand{\cardPthirteen}[1]{%
  ...
  \end{scope}
  % Four hexagrams along the bottom, King Wen 17-20, alternating outlined (white) / filled (black)
  % Same sizing/spacing as prior court cards: 4mm wide, centers 18/26/34/42 at y=7mm
  % ䷐ Suí (Following) — outlined
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
...
\newcommand{\cardSeleven}[1]{%
  ...
  \end{scope}
  % Four hexagrams along the bottom, King Wen 9-12, alternating outlined (white) / filled (black)
  % Same sizing/spacing as Page of Pentacles: 4mm wide, centers 18/26/34/42 at y=7mm
  % ䷈ Xiǎo Xù (Small Taming) — outlined
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
...
\newcommand{\cardSfourteen}[1]{%
  ...
  % Four hexagrams along the bottom, King Wen 13-16, alternating outlined (white) / filled (black)
  % Same sizing/spacing as Page of Pentacles / Page of Swords: 4mm wide, centers 18/26/34/42 at y=7mm
  % ䷌ Tóng Rén (Fellowship) — outlined
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    ...
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{5}\selectfont, align=center]
      at (0, -3mm) {Fellowship};
  \end{scope}
  % ䷍ Dà Yǒu (Great Possession) — filled
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
