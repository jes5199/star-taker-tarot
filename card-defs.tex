...
\newcommand{\cardCsix}[1]{%
  ...
  \begin{scope}
    ...
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
    (0.5\cardwidth-5.4mm, 19mm-7.5mm)
    rectangle
    (0.5\cardwidth+5.4mm, 19mm+7.5mm);
...
\newcommand{\cardCseven}[1]{%
  ...
  \begin{scope}
    \clip[rounded corners=1mm]
      (0.5\cardwidth-5.4mm, 17mm-7.5mm)
      rectangle
      (0.5\cardwidth+5.4mm, 17mm+7.5mm);
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/tree-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardCeight}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/moon-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardCnine}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/rider-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardCten}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/dog-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardCeleven}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,0,0,0,1} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
        \draw[line width=0.4mm] (0.33mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \fi
    }%
    ...
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {\fittext{7mm}{Nourishment}};
  \end{scope}
  % ䷛ Dà Guò (Great Exceeding) — Day 13 evening, outlined
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,1,1,1,1,0} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (-0.33mm, \i*1mm-2.5mm+0.2mm);
        \fill[white, draw=black, line width=0.15mm]
          (0.33mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \fi
    }%
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Dà Guò};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {Great\\Exceeding};
  \end{scope}
  % ䷞ Xián (Influence) — Day 14 morning, filled
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,0,1,1,1,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,1,1,1,0,0} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
...
\newcommand{\cardCtwelve}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,0,0,1,0,1} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,1,0,0,0} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
  ...
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,1,0,1,1} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,0,1,0,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
...
\newcommand{\cardCthirteen}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,0,0,0,0,1} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Bō};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {Splitting\\Apart};
  \end{scope}
  % ䷗ Fù (Return) — Day 11 evening, outlined
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,0,0,0,0} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
  ...
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,0,1,1,1} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,1,0,0,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
...
\newcommand{\cardCfourteen}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,0,0,0,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,0,0,0,1,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Guān};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {\fittext{7mm}{Contemplation}};
  \end{scope}
  % ䷔ Shì Kè (Biting Through) — Day 10 morning, filled
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,0,1,0,1} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Shì Kè};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {Biting\\Through};
  \end{scope}
  % ䷕ Bì (Grace) — Day 10 evening, outlined
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,1,0,0,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
...
\newcommand{\cardPsix}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/clover-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardPseven}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/birds-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardPeight}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/key-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardPnine}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/coffin-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardPten}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/book-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardPeleven}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,0,0,1,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,1,0,0,0,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Méng};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {Youthful\\Folly};
  \end{scope}
  % ䷄ Xū (Waiting) — Day 2 morning, filled
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,1,0,1,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,1,0,1,1,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
...
\newcommand{\cardPthirteen}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,0,1,0,0,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,0,1,1,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,1,1,0,0,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
...
\newcommand{\cardPfourteen}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,1,0,0,1,1} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,0,0,1,0} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
  ...
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,0,0,1,1} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Zhōng Fú};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {Inner\\Truth};
  \end{scope}
  % ䷽ Xiǎo Guò (Small Exceeding) — Day 29 evening, outlined
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,0,1,1,0,0} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
...
\newcommand{\cardSsix}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/tower-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardSseven}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/letter-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardSeight}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/garden-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardSnine}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/anchor-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardSten}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/ship-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardSeleven}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,1,0,0,0,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,0,0,0,1,0} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Bǐ};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {Holding\\Together};
  \end{scope}
  % ䷈ Xiǎo Chù (Small Taming) — Day 4 morning, filled
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,1,0,1,1} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Xiǎo Chù};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {Small\\Taming};
  \end{scope}
  % ䷉ Lǚ (Treading) — Day 4 evening, outlined
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,0,1,1,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
...
\newcommand{\cardStwelve}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,0,1,0,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,0,1,0,0,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Gèn};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {Keeping\\Still};
  \end{scope}
  % ䷴ Jiàn (Development) — Day 25 morning, filled
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,0,1,0,1,1} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Jiàn};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {\fittext{7mm}{Development}};
  \end{scope}
  % ䷵ Guī Mèi (Marrying Maiden) — Day 25 evening, outlined
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,0,1,0,0} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
...
\newcommand{\cardSthirteen}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,0,1,0,1,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Jiǎn};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {\fittext{7mm}{Obstruction}};
  \end{scope}
  ...
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Jiě};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {\fittext{7mm}{Deliverance}};
  \end{scope}
  % ䷨ Sǔn (Decrease) — Day 19 morning, filled
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,0,0,0,1} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,0,0,1,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
...
\newcommand{\cardSfourteen}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,1,0,0,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,0,0,1,1,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
  ...
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,1,1,1,1} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,1,1,0,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
...
\newcommand{\cardWsix}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/cross-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardWseven}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/mice-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardWeight}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/mountain-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardWnine}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/fox-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardWten}[1]{%
  ...
  \begin{scope}
    ...
    \node[anchor=center, inner sep=0pt]
      at (0.5\cardwidth, 17mm) {%
        \includegraphics[width=10.8mm]{images/bear-crop.png}%
      };
    \ifjaunty\fill[gray, blend mode=color] (-99mm,-99mm) rectangle (99mm,99mm);\fi
  \end{scope}
  \draw[\ifjaunty gray\else black\fi, thick, rounded corners=1mm]
...
\newcommand{\cardWtwelve}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,1,0,1,1,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,1,1,0,1,0} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
  ...
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,1,1,1,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Gé};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {\fittext{7mm}{Revolution}};
  \end{scope}
  % ䷱ Dǐng (The Cauldron) — Day 23 evening, outlined
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,1,1,1,0,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Dǐng};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {\fittext{7mm}{The Cauldron}};
  \end{scope}}
...
\newcommand{\cardWthirteen}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,1,1,1,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Guài};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {\fittext{7mm}{Breakthrough}};
  \end{scope}
  % ䷫ Gòu (Coming to Meet) — Day 20 evening, outlined
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,1,1,1,1,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Gòu};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {Coming\\to Meet};
  \end{scope}
  % ䷬ Cuì (Gathering) — Day 21 morning, filled
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,0,0,1,1,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,1,1,0,0,0} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
...
\newcommand{\cardWfourteen}[1]{%
  ...
  \begin{scope}[shift={(18mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,0,1,1,0,0} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(26mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,0,1,1,0,1} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{4}{5}\selectfont]
      at (0, 2.2mm) {Lǚ};
    \node[anchor=north, text=black, font=\cardfont\fontsize{4}{4}\selectfont, align=center, inner sep=0.5pt]
      at (0, -3mm) {The\\Wanderer};
  \end{scope}
  % ䷸ Xùn (The Gentle) — Day 27 morning, filled
  \begin{scope}[shift={(34mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {0,1,1,0,1,1} {%
      \ifnum\type=1
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (2mm, \i*1mm-2.5mm);
      \else
        \draw[line width=0.4mm] (-2mm, \i*1mm-2.5mm) -- (-0.33mm, \i*1mm-2.5mm);
  ...
  \begin{scope}[shift={(42mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {1,1,0,1,1,0} {%
      \ifnum\type=1
        \fill[white, draw=black, line width=0.15mm]
          (-2mm, \i*1mm-2.5mm-0.2mm) rectangle (2mm, \i*1mm-2.5mm+0.2mm);
      \else
