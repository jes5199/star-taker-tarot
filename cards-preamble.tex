...
% Save real black/white before any dark-mode swap
\colorlet{lenormandblack}{black}
\colorlet{lenormandwhite}{white}

% Jaunty-card flag: when true, Lenormand minicards render greyscale
\newif\ifjaunty

% Chakra label colors (redefined lighter in dark mode)
\colorlet{chakraviolet}{violet}
\colorlet{chakrablue}{blue}
\colorlet{chakraindigo}{blue!50!violet}

% Border toggle: true by default, false for print (bleed cards)
\newif\ifshowborder \showbordertrue
...
% Scale factor for print: 70mm/60mm = 1.16667
\def\cardscale{1.16667}
...
\newfontface\cardfontnotrak{EB Garamond SC}  % same font, no tracking — for arc text measurement
\newfontface\cardfontplain{EB Garamond}
\newfontface\rankfont{cardcharacters.ttf}[Path=/home/jes/tarot/]

% Hebrew font + bidi support for RTL
\usepackage{luabidi}
\newfontface\hebrewfont{Noto Serif Hebrew}[Script=Hebrew]
...
\end{tikzpicture}}}
% Inline text versions of alchemical primes (for use in paragraphs)
\newcommand{\textsulfur}{\raisebox{0.775mm}{\begin{tikzpicture}[baseline=0mm, line width=0.35mm, line cap=butt, scale=0.5]
  \draw (0,-2mm) -- (0,0.5mm);
  \draw (-1mm,-0.75mm) -- (1mm,-0.75mm);
  \draw (-1.5mm,0.5mm) -- (0,3mm) -- (1.5mm,0.5mm) -- cycle;
\end{tikzpicture}}}
\newcommand{\textsalt}{\raisebox{1.2mm}{\begin{tikzpicture}[baseline=0mm, line width=0.35mm, scale=0.5]
  \draw (0,0) circle (2mm);
  \draw (-2mm,0) -- (2mm,0);
\end{tikzpicture}}}
\newcommand{\textmercury}{\raisebox{1.2mm}{\begin{tikzpicture}[baseline=0mm, line width=0.35mm, line cap=butt, scale=0.5]
  \draw (0,-2.75mm) -- (0,-0.5mm);
  \draw (-1mm,-1.5mm) -- (1mm,-1.5mm);
  \draw (-1mm,1.8mm) -- (-1mm,0.5mm) arc (180:360:1mm) -- (1mm,1.8mm);
\end{tikzpicture}}}
...
\newcommand{\alcsulfur}{%
  % Lí trigram (Fire) — left side: solid (red top), broken, solid
  ...
  \end{scope}%
  % Qián trigram (Heaven) — right side: all solid (yellow top)
  \begin{scope}[shift={(0.5\cardwidth+23mm,0.52\cardheight)}, line width=2mm, line cap=butt]
  ...
  \node[anchor=base, text=black, font=\hebrewfont\fontsize{14}{16}\selectfont]
    at (0.5\cardwidth-21mm, 0.52\cardheight-40.5mm) {\RLE{נשמה}};
  ...
  \begin{scope}[shift={(7mm,4mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{5}{6}\selectfont|Lot of Spirit},
  ...
  \begin{scope}[shift={(\cardwidth-7mm,5mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{5}{6}\selectfont\color{red}|hóng  zhōng},
      text align=center, raise=0pt}}]
      (170:3mm) arc (170:10:3mm);
    % "bullseye" curved below
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{5}{6}\selectfont\color{red}|bullseye},
...
\newcommand{\alcsalt}{%
  \begin{scope}[shift={(0.5\cardwidth,0.52\cardheight)}, cyan, line width=3.5mm]
    ...
    \draw (-14mm,0) -- (14mm,0);
  \end{scope}%
  % Kǎn trigram (Water) — left side: broken, solid, broken (bottom line blue)
  \begin{scope}[shift={(0.5\cardwidth-23mm,0.52\cardheight)}, line width=2mm, line cap=butt]
    % Top line — broken
  ...
  % נפש above nefesh
  \node[anchor=base, text=black, font=\hebrewfont\fontsize{14}{16}\selectfont]
    at (0.5\cardwidth-21mm, 0.52\cardheight-40.5mm) {\RLE{נפש}};
  \node[anchor=base, text=black, font=\cardfont\fontsize{10}{12}\selectfont]
  ...
  \begin{scope}[shift={(7mm,4mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{5}{6}\selectfont|Lot of Fortune},
      text align=center, raise=0pt}}]
      (190:3.5mm) arc (190:-10:3.5mm);
  \end{scope}%
  ...
  \begin{scope}[shift={(\cardwidth-7mm,5mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{5}{6}\selectfont|bái bǎu},
      text align=center, raise=0pt}}]
      (170:3.5mm) arc (170:10:3.5mm);
    % "clean slate" curved below
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{5}{6}\selectfont|clean slate},
      text align=center, raise=1pt, reverse path}}]
      (-10:4.5mm) arc (-10:-170:4.5mm);
  \end{scope}%
  % water & earth
...
\newcommand{\alcmercury}{%
  ...
  \node[anchor=base, text=black, font=\hebrewfont\fontsize{14}{16}\selectfont]
    at (0.5\cardwidth-21mm, 0.52\cardheight-40.5mm) {\RLE{רוח}};
  \node[anchor=base, text=black, font=\cardfont\fontsize{10}{12}\selectfont]
  ...
  % Kǎn trigram (Water) — left side: broken, solid (blue), broken
  \begin{scope}[shift={(0.5\cardwidth-23mm,0.52\cardheight)}, line width=2mm, line cap=butt]
    % Top line — broken
    \draw (-4mm,5mm) -- (-1mm,5mm);
    \draw (1mm,5mm) -- (4mm,5mm);
    ...
    \node[below, font=\cardfont\fontsize{10}{12}\selectfont] at (0,-6mm) {Water};
  \end{scope}%
  % Lí trigram (Fire) — right side: solid, broken (red), solid
  \begin{scope}[shift={(0.5\cardwidth+23mm,0.52\cardheight)}, line width=2mm, line cap=butt]
    % Top line — solid
    \draw (-4mm,5mm) -- (4mm,5mm);
  ...
  \begin{scope}[shift={(7mm,4mm)}]
    ...
    % "Lot of" curved above
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{5}{6}\selectfont|Lot of Eros},
      text align=center, raise=0pt}}]
      (170:3.5mm) arc (170:10:3.5mm);
  \end{scope}%
  ...
  \begin{scope}[shift={(\cardwidth-7mm,5mm)}]
    ...
    % "fa cái" curved above
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{5}{6}\selectfont\color{green!50!black}|fā cái},
      text align=center, raise=0pt}}]
      (170:3mm) arc (170:10:3mm);
    % "strike it rich" curved below
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{5}{6}\selectfont\color{green!50!black}|strike  it  rich},
      text align=center, raise=1pt, reverse path}}]
      (-10:4.5mm) arc (-10:-170:4.5mm);
  \end{scope}%
  \jokertext{black}
...
% Kǎn trigram (Water) block, used twice (left/right of the Mercury glyph) in
% \alcmercurytrad below — #1 = x-shift expression for the scope origin
\newcommand{\kantrigramat}[1]{%
  \begin{scope}[shift={(#1,0.52\cardheight)}, line width=2mm, line cap=butt]
...
\newcommand{\alcmercurytrad}{%
  ...
  \kantrigramat{0.5\cardwidth-23mm}%
  ...
  \begin{scope}[shift={(\cardwidth-11mm,5mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont\color{chakraindigo}|Third Eye},
      text align=center, raise=0pt}}]
...
\newcommand{\plvenus}{%
  ...
  \begin{scope}[shift={(\cardwidth-9mm,7mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont\color{chakrablue}|Voice},
      text align=center, raise=0pt}}]
...
\newcommand{\plsun}{%
  ...
  \node[anchor=north, text=black, font=\cardfont\fontsize{10}{12}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight-49mm) {Great Yang};
  \node[anchor=center, text=black, font=\greekfont\fontsize{18}{20}\selectfont]
    at (7mm, 5mm) {Ι};
  \begin{scope}[shift={(\cardwidth-9mm,7mm)}]
    \node[anchor=center, inner sep=0pt] at (0,0) {\includegraphics[width=14mm]{images/chakra4}};
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont\color{green!50!black}|Heart},
      text align=center, raise=0pt}}]
      (170:8mm) arc (170:10:8mm);
  \end{scope}%
}
...
\newcommand{\plmars}{%
  ...
  \begin{scope}[shift={(\cardwidth-9mm,7mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont\color{yellow!50!orange}|Solar Plexus},
      text align=center, raise=0pt}}]
      (170:8mm) arc (170:10:8mm);
  \end{scope}%
}
...
\newcommand{\pljupiter}{%
  ...
  \begin{scope}[shift={(\cardwidth-9mm,7mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont\color{orange}|Sacral},
      text align=center, raise=0pt}}]
      (160:8mm) arc (160:0:8mm);
  \end{scope}%
}
...
\newcommand{\plsaturn}{%
  \node[anchor=center, text=black, font=\symbserif\fontsize{160}{170}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight) {♄};
  % Gèn trigram (Mountain) — left side: solid top, broken, broken
  \begin{scope}[shift={(0.5\cardwidth-23mm,0.52\cardheight)}, line width=2mm, line cap=butt]
    \draw (-4mm,5mm) -- (4mm,5mm);
    \draw (-4mm,0mm) -- (-1mm,0mm); \draw (1mm,0mm) -- (4mm,0mm);
    \draw (-4mm,-5mm) -- (-1mm,-5mm); \draw (1mm,-5mm) -- (4mm,-5mm);
  ...
  \end{scope}%
  % Kūn trigram (Earth) — right side: all broken
  \begin{scope}[shift={(0.5\cardwidth+23mm,0.52\cardheight)}, line width=2mm, line cap=butt]
    \draw (-4mm,5mm) -- (-1mm,5mm); \draw (1mm,5mm) -- (4mm,5mm);
    \draw (-4mm,0mm) -- (-1mm,0mm); \draw (1mm,0mm) -- (4mm,0mm);
    \draw (-4mm,-5mm) -- (-1mm,-5mm); \draw (1mm,-5mm) -- (4mm,-5mm);
  ...
  \begin{scope}[shift={(\cardwidth-9mm,7mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont\color{red}|Root},
      text align=center, raise=0pt}}]
      (170:8mm) arc (170:10:8mm);
  \end{scope}%
}
...
\newcommand{\plmoon}{%
  ...
  \node[anchor=north, text=black, font=\cardfont\fontsize{10}{12}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight-49mm) {Great Yin};
  \node[anchor=center, text=black, font=\greekfont\fontsize{18}{20}\selectfont]
    at (7mm, 5mm) {Α};
  \begin{scope}[shift={(\cardwidth-9mm,7mm)}]
    \node[anchor=center, inner sep=0pt] at (0,0) {\includegraphics[width=14mm]{images/chakra7}};
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont\color{chakraviolet}|Crown},
      text align=center, raise=0pt}}]
      (170:8mm) arc (170:10:8mm);
  \end{scope}%
}
...
\newcommand{\triplicityrulers}[3]{%
  ...
  \begin{scope}[shift={(0.5\cardwidth, 0.52\cardheight-35.5mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont|day},
      text align=center, raise=0pt}}]
      (-14.33mm, 0.5mm) arc (150:30:5mm);
    % Night ruler
    \node[anchor=center, text=black] at (0, 0) {#2};
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont|night},
      text align=center, raise=0pt}}]
...
\newcommand{\decanrulers}[3]{%
  \begin{scope}[shift={(0.5\cardwidth, 0.52\cardheight-41.5mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont|0-10},
      text align=center, raise=0pt}}]
      (-15.2mm, -1mm) arc (210:330:6mm);
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont|10-20},
      text align=center, raise=0pt}}]
      (-5.2mm, -1mm) arc (210:330:6mm);
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont|20-30},
      text align=center, raise=0pt}}]
...
% #6=earthly branch pinyin, #7=earthly branch hanzi, #8=earthly branch animal
\newcommand{\drawhexagram}[8]{%
  \begin{scope}[shift={(#1, #2)}, line width=1.5mm, line cap=butt]
    ...
    \node[anchor=south, text=black, font=\cardfont\fontsize{8}{9}\selectfont]
      at (0, 13mm) {#4};
    \node[anchor=north, text=black, font=\cardfont\fontsize{8}{9}\selectfont, align=center]
      at (0, -13mm) {#5};
    % Earthly branch
    \node[anchor=base, text=black, font=\cardfont\fontsize{7}{8}\selectfont]
      at (0, -21mm) {#6};
...
%
% \zodiacoverlay{color}{glyph}{xscale opts}{sign name}{planet font}
%               {planet symbol}{planet name}{modality/element}{rest}
%   #1 color        — text color of the big zodiac glyph
%   #2 glyph        — the zodiac glyph itself (e.g. ♈)
%   #3 xscale opts  — extra tikz options appended after \selectfont on the
%                     glyph node's option list (empty for all but Virgo/
%                     Scorpio, which need a narrower glyph via xscale=N)
%   #4 sign name    — printed sign name (e.g. Aries)
%   #5 planet font  — domicile-planet symbol font (\symbserif or \symbfont)
%   #6 planet symbol — domicile-planet glyph (e.g. ♂)
%   #7 planet name  — domicile-planet name (e.g. Mars)
%   #8 modality/element — e.g. "cardinal fire"
%   #9 rest         — brace-wrapped chunk: tiny element icons, element
%                     rulers, \decanrulers, \solarterms, and the two
%                     \drawhexagram calls (verbatim per-sign content)
\newcommand{\zodiacoverlay}[9]{%
  \node[anchor=center, text=#1, font=\symbserif\fontsize{160}{170}\selectfont#3]
    at (0.5\cardwidth, 0.52\cardheight) {#2};
  \node[anchor=north, text=black, font=\cardfont\fontsize{17}{19}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight-24mm) {#4};
  \node[anchor=base east, text=black, font=\cardfont\fontsize{9}{11}\selectfont, inner xsep=3mm]
    at (0.5\cardwidth, \cardheight-10mm) {\resizebox{12mm}{\height}{Domicile of}};
  \node[anchor=base, text=black, font=#5\fontsize{12}{14}\selectfont]
    at (0.5\cardwidth, \cardheight-10mm) {#6};
  \node[anchor=base west, text=black, font=\cardfont\fontsize{9}{11}\selectfont, inner xsep=3mm]
    at (0.5\cardwidth, \cardheight-10mm) {#7};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, \cardheight-10mm) {#8};
  #9%
}
% Aries (Emperor) — Red — Domicile of Mars
\newcommand{\zdaries}{%
  \zodiacoverlay{red}{♈}{}{Aries}{\symbserif}{♂}{Mars}{cardinal fire}{%
...
\newcommand{\zdtaurus}{%
  \zodiacoverlay{red!50!orange}{♉}{}{Taurus}{\symbserif}{♀}{Venus}{fixed earth}{%
...
\newcommand{\zdgemini}{%
  \zodiacoverlay{orange}{♊}{}{Gemini}{\symbserif}{☿}{Mercury}{mutable air}{%
  ...
  \solarterms{小滿}{Xiǎomǎn}{Grain Buds}{芒種}{Mángzhòng}{Grain in Ear}{red}{red}
...
\newcommand{\zdcancer}{%
  \zodiacoverlay{yellow!50!orange}{♋}{}{Cancer}{\symbfont}{☽}{Moon}{cardinal water}{%
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-16mm) {\tinysulfur};
...
\newcommand{\zdleo}{%
  \zodiacoverlay{yellow!80!orange}{♌}{}{Leo}{\symbfont}{☉}{Sun}{fixed fire}{%
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-16mm) {\tinysalt};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-16mm) {\tinyfire};
  \firerulers
...
\newcommand{\zdvirgo}{%
  \zodiacoverlay{yellow!50!green}{♍}{,
    xscale=0.78}{Virgo}{\symbserif}{☿}{Mercury}{mutable earth}{%
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-16mm) {\tinymercury};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-16mm) {\tinyearth};
  \earthrulers
  \decanrulers{\rSun}{\rVenus}{\rMercury}
  \solarterms{處暑}{Chǔshǔ}{End of Heat}{白露}{Báilù}{White Dew}{white}{white}
...
\newcommand{\zdlibra}{%
  \zodiacoverlay{green!70!black}{♎}{}{Libra}{\symbserif}{♀}{Venus}{cardinal air}{%
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-16mm) {\tinysulfur};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-16mm) {\tinyair};
  \airrulers
...
\newcommand{\zdscorpio}{%
  \zodiacoverlay{blue!50!green}{♏}{,
    xscale=0.73}{Scorpio}{\symbserif}{♂}{Mars}{fixed water}{%
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-16mm) {\tinysalt};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-16mm) {\tinywater};
  \waterrulers
  \decanrulers{\rMars}{\rSun}{\rVenus}
...
\newcommand{\zdsagittarius}{%
  \zodiacoverlay{blue}{♐}{}{Sagittarius}{\symbserif}{♃}{Jupiter}{mutable fire}{%
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-16mm) {\tinymercury};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-16mm) {\tinyfire};
  \firerulers
  \decanrulers{\rMercury}{\rMoon}{\rSaturn}
...
\newcommand{\zdcapricorn}{%
  \zodiacoverlay{blue!50!violet}{♑}{}{Capricorn}{\symbserif}{♄}{Saturn}{cardinal earth}{%
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-16mm) {\tinysulfur};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-16mm) {\tinyearth};
  \earthrulers
  \decanrulers{\rJupiter}{\rMars}{\rSun}
...
\newcommand{\zdaquarius}{%
  \zodiacoverlay{violet}{♒}{}{Aquarius}{\symbserif}{♄}{Saturn}{fixed air}{%
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-16mm) {\tinysalt};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-16mm) {\tinyair};
  \airrulers
  \decanrulers{\rVenus}{\rMercury}{\rMoon}
...
\newcommand{\zdpisces}{%
  \zodiacoverlay{red!50!violet}{♓}{}{Pisces}{\symbserif}{♃}{Jupiter}{mutable water}{%
  \node[anchor=center, text=black] at (0.5\cardwidth-3.5mm, \cardheight-16mm) {\tinymercury};
  \node[anchor=center, text=black] at (0.5\cardwidth+3.5mm, \cardheight-16mm) {\tinywater};
  \waterrulers
  \decanrulers{\rSaturn}{\rJupiter}{\rMars}
  \solarterms{雨水}{Yǔshuǐ}{Rain Water}{驚蟄}{Jīngzhé}{Awakening of Insects}{blue}{blue}
...
\newcommand{\lunarstack}[2]{%
  ...
  \def\inannaitem{\ifcase#1\or robe\or anklet\or ring\or breastplate\or lapis necklace\or rod and staff\or crown\fi}%
  \ifx\direction\isdescending
    \node[anchor=center, text=black, font=\cardfont\fontsize{7}{9}\selectfont, rotate=-90]
...
% Optional #1 = label override (default: auto day-pair from phase)
% #2 = x, #3 = y, #4 = phase (0=new, 4=first quarter, 8=full, 12=third quarter)
\newcommand{\drawmoonphase}[4][]{%
  \begin{scope}[shift={(#2,#3)}]
    \pgfmathtruncatemacro{\p}{#4}%
    ...
    % Label: new=0 and full=15 are singletons; all others are day-pairs (e.g. 1/2, 16/17).
    % Optional arg overrides the default (e.g. [30/0] for the Knight of Pentacles).
    \node[anchor=north, text=black, font=\cardfont\fontsize{9}{10}\selectfont]
      at (0, -3.2mm) {\ifx\relax#1\relax\ifcase#4 0\or 1/2\or \underline{3}/4\or 5/6\or 7/\underline{8}\or 9/10\or 11/12\or 13/14\or \underline{15}\or \underline{16}/17\or 18/19\or 20/21\or 22/\underline{23}\or 24/25\or 26/27\or 28/29\fi\else#1\fi};
  \end{scope}%
}
...
% Lunar node attribution — used by the Page/Knave of court cards whose
% attribute block departs from \courtattrib (north/south node, glyph, name,
% Devanagari, and gloss all differ; y-offsets are fixed).
% #1 = north/south, #2 = node glyph, #3 = node name, #4 = Devanagari name,
% #5 = "Head/Tail of the Dragon" gloss
\newcommand{\nodeattrib}[5]{%
  \node[anchor=base east, text=black, font=\cardfont\fontsize{12}{14}\selectfont, inner xsep=4mm]
    at (0.5\cardwidth, 0.52\cardheight-35mm) {#1};
  \node[anchor=base, text=black, font=\symbfont\fontsize{16}{18}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight-35mm) {#2};
  ...
  \node[anchor=base, text=black, font=\cardfont\fontsize{10}{12}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight-42mm) {#3};
  \node[anchor=north, text=black, font=\devfont\fontsize{14}{16}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight-42mm) {#4};
  \node[anchor=north, text=black, font=\cardfont\fontsize{9}{11}\selectfont]
    at (0.5\cardwidth, 0.52\cardheight-48mm) {#5};%
}

% Fixed star: ★ glyph + name label at degree position
% #1 = optional TikZ/pgfkeys settings, #2 = degree position in decan (0-10), #3 = star name
...
% #2 = degree position (bottom of pāda span), #3 = unused (kept for compat), #4 = syllable
\newcounter{padactr}
...
% #1 = optional TikZ keys, #2 = pada node name, #3 = rāśi symbol, #4 = rāśi Devanagari, #5 = rāśi romanization
...
% #1 = optional mahjong tile, #2 = numeral (e.g. 一), #3 = suit name (e.g. 条)
...
\newcommand{\acewands}{%
  ...
  \begin{scope}[shift={(7mm,8mm)}]
    \node[anchor=center, text=black, font=\cjkfont\fontsize{28}{30}\selectfont]
      at (0,0) {東};
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont|dōng},
      text align=center, raise=0pt}}]
      (170:5mm) arc (170:10:5mm);
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont|east},
      text align=center, raise=1pt, reverse path}}]
...
\newcommand{\acecups}{%
  ...
  \draw[black, thick, rounded corners=1mm]
    ...
    (0.5\cardwidth-22mm+5.4mm, 0.52\cardheight-24mm+7.5mm);
  \node[anchor=south east, text=lenormandblack, font=\cardfont\fontsize{10}{11}\selectfont,
    inner sep=0pt] at (0.5\cardwidth-17mm, 0.52\cardheight-31mm) {2\kern-0.3ex8};
  \node[anchor=north, text=black, font=\cardfont\fontsize{17}{19}\selectfont]
  ...
  \begin{scope}[shift={(7mm,8mm)}]
    \node[anchor=center, text=black, font=\cjkfont\fontsize{28}{30}\selectfont]
      at (0,0) {南};
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont|nán},
      text align=center, raise=0pt}}]
      (170:5mm) arc (170:10:5mm);
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont|south},
      text align=center, raise=1pt, reverse path}}]
      (-10:6.5mm) arc (-10:-170:6.5mm);
  \end{scope}%
...
\newcommand{\aceswords}{%
  ...
  \foreach \angle in {0,22.5,...,337.5}{
    \node[anchor=south east, text=lenormandblack, font=\cardfont\fontsize{10}{11}\selectfont,
      inner sep=0pt, xshift={0.15*cos(\angle)*1mm}, yshift={0.15*sin(\angle)*1mm}] at (0.5\cardwidth-17mm, 0.52\cardheight-31mm) {29};
  }
  ...
  \drawsmallhexagram{0.5\cardwidth}{0.52\cardheight-41mm}{1,1,0,1,1,0}{Duì}{Joyous}
  \node[anchor=north, text=black, font=\cardfont\fontsize{11}{13}\selectfont]
  ...
  \begin{scope}[shift={(7mm,8mm)}]
    \node[anchor=center, text=black, font=\cjkfont\fontsize{28}{30}\selectfont]
      at (0,0) {西};
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont|xī},
      text align=center, raise=0pt}}]
      (170:5mm) arc (170:10:5mm);
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont|west},
      text align=center, raise=1pt, reverse path}}]
      (-10:6.5mm) arc (-10:-170:6.5mm);
  \end{scope}%
...
\newcommand{\acepentacles}{%
  ...
  \begin{scope}[shift={(7mm,8mm)}]
    \node[anchor=center, text=black, font=\cjkfont\fontsize{28}{30}\selectfont]
      at (0,0) {北};
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont|běi},
      text align=center, raise=0pt}}]
      (170:5mm) arc (170:10:5mm);
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfontnotrak\fontsize{7}{8}\selectfont|north},
      text align=center, raise=1pt, reverse path}}]
      (-10:6.5mm) arc (-10:-170:6.5mm);
  \end{scope}%
...
\newcommand{\tarotcard}[5][]{%
  ...
  \begin{tikzpicture}
    ...
    % Wash out the image (oversized so it covers under the border stroke)
    \fill[white, opacity=0.88] (-1mm,-1mm) rectangle (\cardwidth+1mm,\cardheight+1mm);
...
\newcommand{\hexagram}[6]{%
  ...
  % +3.75 (not +4.5) keeps the bottom label 0.75mm clear of the hex at #1=1
  % position (sovereign-hexagram pivot row); other positions hit the -4.5 clamp.
  \pgfmathsetmacro{\hexbotlabel}{max(-4.5, -\hextickpos * 25.4/72.27 + 3.75)}%
...
% Court-card bottom-row hexagram (filled/solid style): \courthexagramfilled{xShift}{line1,...,line6}{pinyin}{gloss}
% xShift = x-offset in mm (y is fixed at 7mm); the 4 hexagrams along a court
% card's bottom row sit at 18/26/34/42mm. Lines are bottom to top, Yang=1
% (solid), Yin=0 (broken). Used for "filled" (in-decan / emphasized) hexagrams,
% drawn as solid 0.4mm strokes. gloss may contain raw tokens (e.g. \\ line
% breaks or a \fittext{7mm}{...} wrapper) — it is substituted verbatim.
\newcommand{\courthexagramfilled}[4]{%
  \begin{scope}[shift={(#1mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {#2} {%
      \ifnum\type=1
...
% Court-card bottom-row hexagram (outlined style): \courthexagramoutlined{xShift}{line1,...,line6}{pinyin}{gloss}
% Same parameters as \courthexagramfilled; used for "outlined" (out-of-decan
% / de-emphasized) hexagrams, drawn as hollow 0.15mm-stroke rectangles.
\newcommand{\courthexagramoutlined}[4]{%
  \begin{scope}[shift={(#1mm, 7mm)}, line cap=butt]
    \foreach \type [count=\i from 0] in {#2} {%
      \ifnum\type=1
...
% Inline Lenormand mini-card: clipped/bordered image swatch + number badge.
% \lenormandcard{centerX}{centerY}{includegraphics sizing}{image basename}{badge}
% centerX/centerY = tikz coordinate expressions for the swatch center (the
% clip/border rectangle is always centerX/Y ± 5.4mm/7.5mm); sizing is the
% raw \includegraphics[...] option (width=10.8mm or height=15mm); image
% basename resolves to images/<name>-crop.png; badge is the site's own
% literal number-badge node(s) — either a single \node, or a 16-copy
% \foreach halo followed by the solid \node — passed through verbatim since
% anchor side, color, paint order, and y-nudge all vary per site.
\newcommand{\lenormandcard}[5]{%
  \begin{scope}
    \clip[rounded corners=1mm]
      (#1-5.4mm, #2-7.5mm)
      rectangle
    ...
    \node[anchor=center, inner sep=0pt]
      at (#1, #2) {%
        \includegraphics[#3]{images/#4-crop.png}%
      };
...
\newcommand{\minorcardimgwidth}{1.0\cardwidth}
\newcommand{\minorcard}[3][]{%
  ...
  \begin{tikzpicture}
    ...
    \clip[rounded corners=2.5mm] (0,0) rectangle (\cardwidth,\cardheight);
    % Background image - shifted down to crop off Smith's lettering at bottom
    \node[anchor=south, inner sep=0pt] at (0.5\cardwidth,\minorcardshift) {%
      \includegraphics[width=\minorcardimgwidth]{#2}%
    };
    % Wash out the image (oversized so it covers under the border stroke)
    \fill[white, opacity=0.88] (-1mm,-1mm) rectangle (\cardwidth+1mm,\cardheight+1mm);
    % Center overlay (if any)
...
% Card back (shared by cards-body, singles-body, print-body; \cardscale is read at call time)
\newcommand{\cardback}{%
\scalebox{\cardscale}{%
\begin{tikzpicture}
  \useasboundingbox (0,0) rectangle (\cardwidth, \cardheight);
