...
\newcommand{\alcmercurytrad}{%
  ...
  \begin{scope}[shift={(\cardwidth-11mm,5mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfont\fontsize{7}{8}\selectfont\color{chakraindigo}|Third Eye},
      text align=center, raise=0pt}}]
      (163:6mm) arc (163:3:6mm);
  \end{scope}%
  \jokertext{red}
}
...
\newcommand{\plvenus}{%
  ...
  \begin{scope}[shift={(\cardwidth-9mm,7mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfont\fontsize{7}{8}\selectfont\color{chakrablue}|Voice},
      text align=center, raise=0pt}}]
      (165:8mm) arc (165:5:8mm);
  \end{scope}%
}
...
\newcommand{\plmoon}{%
  ...
  \begin{scope}[shift={(\cardwidth-9mm,7mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfont\fontsize{7}{8}\selectfont\color{chakraviolet}|Crown},
      text align=center, raise=0pt}}]
      (165:8mm) arc (165:5:8mm);
  \end{scope}%
}
...
\newcommand{\acewands}{%
  ...
  \begin{scope}[shift={(7mm,8mm)}]
    ...
    \path[postaction={decorate, decoration={text along path,
      ...
      text align=center, raise=0pt}}]
      (165:5mm) arc (165:5:5mm);
    \path[postaction={decorate, decoration={text along path,
      text={|\cardfont\fontsize{7}{8}\selectfont|east},
      text align=center, raise=1pt, reverse path}}]
      (-15:6.5mm) arc (-15:-175:6.5mm);
  \end{scope}%
